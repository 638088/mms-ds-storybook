import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,m as r,n as i,s as a,t as o}from"./lit-CBo78ikN.js";import{a as s,f as c,m as l,n as u,o as d,r as f,t as p,u as m}from"./decorate-BdwtT8fT.js";import{t as h}from"./mms-icon.component-B0xp-9Qj.js";import{n as g,t as _}from"./iframe-DuNKalfB.js";import{n as v,r as y,t as b}from"./theme-constraints-HoH5pJ5P.js";import{a as x,o as S,r as C,t as w}from"./a11y-outcome-DcpqwzN2.js";var T,E=e((()=>{o(),d(),s(),h(),u(),T=class extends i{constructor(...e){super(...e),this.variant=`outlined`,this.colorScheme=`primary`,this.titleText=``,this.subtitleText=``,this.subtitleRightText=``,this.descriptionText=``,this.showMedia=!1,this.mediaHeight=`default`,this.showBody=!0,this.showActions=!1,this.actionStyle=`1-action`,this.icon=``,this.showActionMenu=!1,this.actionMenuLabel=`More actions`,this.showDescription=!0,this.titleSize=`heading-4`,this.roundness=`subtle`,this.surface=`solid`,this.descriptionLines=0,this.density=`default`,this._menuOpen=!1,this._handleSlotChange=()=>{this._propagateDensity()},this._handleOutsideClick=e=>{this._menuOpen&&(e.composedPath().includes(this)||(this._menuOpen=!1))},this._toggleMenu=e=>{e.stopPropagation(),this._menuOpen=!this._menuOpen},this._handleMenuKeyDown=e=>{e.key===`Escape`&&this._menuOpen&&(e.preventDefault(),this._menuOpen=!1,(this.shadowRoot?.querySelector(`.action-icon`))?.focus())}}static{this.styles=[f,r`
      /* ═══════════════════════════════════════════════════════════════════════
...
&lt;/mms-card&gt;</code></pre>
  ...
  `+r.join(`
  `):``}\n></mms-card>`},language:`html`}}},render:e=>{let t=e.showActions&&e.actionStyle!==`link`,r=!t||y(e.theme,e.actionColorScheme);return a`
      <mms-card
        variant=${e.variant}
      ...
      >
        ...
        ${e.showBodyContent?a`
            ...
            `:n}
        ${t&&!r?(()=>{let t=b(e.theme,e.actionColorScheme),n=t===2?`Tier 2 (Text + Surface)`:`Tier 3 (Decorative)`,r=t===2?`Lacks step 10 (hover state). Use for branded text or badges, not buttons.`:`Lacks text contrast and hover states. Decorative backgrounds only.`;return a`
                <div
                  slot="actions"
                  style="
