import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{s as t,t as n}from"./lit-CBo78ikN.js";import{n as r,t as i}from"./package-DfXdAuxu.js";var a,o,s,c,l;e((()=>{n(),i(),a=`960px`,o=r.version,s={title:`Developer Guide/Installation (Old)`},c={name:`Installation (Old)`,render:()=>t`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${a}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 1rem; border-radius: 0 8px 8px 0; margin-bottom: 2rem; font-size: 0.875rem; color: #92400e;">
        <strong>⚠️ Superseded — use "Installation" instead.</strong> This page is retained only until the current install path has been signed off on Windows. Its commands are macOS/Linux-only: <code style="background: rgba(0,0,0,0.1); padding: 2px 6px; border-radius: 4px;">grep</code> and <code style="background: rgba(0,0,0,0.1); padding: 2px 6px; border-radius: 4px;">sed</code> do not exist in Windows PowerShell or cmd.exe, and the backslash line continuation in Step 1 silently drops the <code style="background: rgba(0,0,0,0.1); padding: 2px 6px; border-radius: 4px;">--registry</code> flag on those shells — producing a 404 that reads like a permissions error.
      </div>
...
<span style="color: #d4d4d4;">└── @mms/design-system@${o}</span></code></pre>
...
<span style="color: #6a9955;"># Expected output:</span>
<span style="color: #d4d4d4;">your-project@1.0.0</span>
<span style="color: #d4d4d4;">└── @mms/design-system@\${VERSION}</span></code></pre>
  ...
  \`
}`,...c.parameters?.docs?.source}}},l=[`Installation`]}))();export{c as Installation,l as __namedExportsOrder,s as default};