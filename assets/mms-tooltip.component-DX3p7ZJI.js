import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{i as t,m as n,n as r,s as i,t as a}from"./lit-CBo78ikN.js";import{a as o,f as s,m as c,n as l,o as u,r as d,t as f,u as p}from"./decorate-BdwtT8fT.js";import{t as m}from"./mms-icon.component-B0xp-9Qj.js";var h,g=e((()=>{a(),u(),o(),m(),l(),h=class extends r{constructor(...e){super(...e),this.text=`Tooltip text`,this.size=`md`,this.direction=`below-right`,this.iconSize=`sm`,this.trigger=`hover`,this.active=!1,this._hasSlottedContent=!1,this._effectiveDirection=`below-right`,this._handleMouseEnter=()=>{this.trigger===`hover`&&(this.active=!0)},this._handleMouseLeave=()=>{this.trigger===`hover`&&(this.active=!1)},this._handleFocusIn=e=>{e.target.matches(`:focus-visible`)&&(this.trigger===`hover`||this.trigger===`focus`)&&(this.active=!0)},this._handleFocusOut=()=>{(this.trigger===`hover`||this.trigger===`focus`)&&(this.active=!1)},this._toggleTooltip=e=>{this.trigger===`click`&&(e.stopPropagation(),this.active=!this.active)},this._handleOutsideClick=e=>{this.trigger!==`click`||!this.active||e.composedPath().includes(this)||(this.active=!1)},this._handleKeydown=e=>{if(e.key===`Escape`&&this.active){this.active=!1;return}this.trigger===`click`&&(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.active=!this.active)},this._handleResize=()=>{this.active&&this._updatePosition()},this._handleSlotChange=e=>{let t=e.target.assignedNodes({flatten:!0});this._hasSlottedContent=t.some(e=>e.nodeType===Node.ELEMENT_NODE||e.nodeType===Node.TEXT_NODE&&!!e.textContent?.trim())}}static{this.styles=[d,n`
      :host {
    ...
    `}},f([s({type:String})],h.prototype,`text`,void 0),f([s({type:String})],h.prototype,`size`,void 0),f([s({type:String,reflect:!0})],h.prototype,`direction`,void 0),f([s({type:String,attribute:`icon-size`})],h.prototype,`iconSize`,void 0),f([s({type:String})],h.prototype,`trigger`,void 0),f([s({type:Boolean,reflect:!0})],h.prototype,`active`,void 0),f([p()],h.prototype,`_hasSlottedContent`,void 0),h=f([c(`mms-tooltip`)],h)}));export{g as t};