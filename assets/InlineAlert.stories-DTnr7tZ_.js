import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,m as r,n as i,s as a,t as o}from"./lit-CBo78ikN.js";import{d as s,l as c,n as l,r as u,t as d}from"./decorate-Bygya6Tu.js";import{n as f,r as p}from"./focus.css-BrGuLyxh.js";import{t as m}from"./mms-icon.component-DRWi1aVe.js";import{t as h}from"./iframe-BrTwVG2K.js";import{a as g,o as _,r as v,t as y}from"./a11y-outcome-CiARakld.js";import{n as b,t as x}from"./normalize-alert-type-C-qeRm_W.js";var S,C,w=e((()=>{o(),u(),p(),x(),m(),h(),l(),S=`informational`,C=class extends i{constructor(...e){super(...e),this.alertType=`informational`,this.dismissible=!0,this.action=!1,this.summary=``,this.message=``,this.actionText=`Text link`,this.actionHref=`#`,this._handleDismiss=()=>{this.dispatchEvent(new CustomEvent(`dismiss`,{bubbles:!0,composed:!0}))},this._handleActionClick=()=>{this.dispatchEvent(new CustomEvent(`action-click`,{bubbles:!0,composed:!0,detail:{href:this.actionHref}}))}}static{this.styles=[f,r`
    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${k}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <p style="${D.body} opacity: 0.85; max-width: ${O}; margin-bottom: 2rem;">
        ...
        <code style="${D.monoSm}">mms-alert-banner</code>'s page-level placement, inline alert is meant to be
        embedded directly alongside the content it refers to. Announced assertively to assistive technology via
        <code style="${D.monoSm}">role="alert"</code>.
      </p>
      ...
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
        Defaults to the <code style="${D.monoSm}">informational</code> type with a close button and no text-link action.
      </p>
      ...
      <!-- With action -->
      <h2 style="${D.h2}">With a text-link action</h2>
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
        Setting <code style="${D.monoSm}">action</code> to <code style="${D.monoSm}">true</code> renders a text
        link below the message — off by default, unlike <code style="${D.monoSm}">mms-alert-banner</code>.
      </p>
      ...
      <!-- Without dismiss -->
      <h2 style="${D.h2}">Without a close button</h2>
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
        Setting <code style="${D.monoSm}">dismissible</code> to <code style="${D.monoSm}">false</code> hides the
      ...
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
        The close button fires a <code style="${D.monoSm}">dismiss</code> event — the host page owns removal from
        the DOM (e.g. <code style="${D.monoSm}">@dismiss=\${() => el.remove()}</code>); the component does not
      ...
      <div style="background: rgba(34, 197, 94, 0.08); border-left: 3px solid #22C55E; padding: 1rem 1.25rem; margin-bottom: 1.5rem; border-radius: 0 6px 6px 0;">
        <p style="${D.bodySm} margin: 0;">
          <strong>Why <code style="${D.monoSm}">role="alert"</code>, not <code style="${D.monoSm}">role="status"</code>?</strong>
          ...
          <code style="${D.monoSm}">role="alert"</code>'s implicit <code style="${D.monoSm}">aria-live="polite"</code>
          announces it promptly in that immediate context, matching that framing. Use
          <code style="${D.monoSm}">mms-alert-banner</code> instead for page-level status that isn't tied to a
      ...
      <ul style="${D.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        <li style="margin-bottom: 0.5rem;"><strong>On render:</strong> Announces via <code style="${D.monoSm}">role="alert"</code> — summary, message, and action link text are read as content</li>
        <li style="margin-bottom: 0.5rem;"><strong>Alert icon:</strong> Announced via its <code style="${D.monoSm}">aria-label</code> (e.g. "error alert"), not left silent as decorative</li>
