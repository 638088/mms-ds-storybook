import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,m as r,n as i,s as a,t as o}from"./lit-CBo78ikN.js";import{d as s,l as c,n as l,r as u,t as d}from"./decorate-Bygya6Tu.js";import{r as f,t as p}from"./focus.css-BrGuLyxh.js";import{t as m}from"./mms-icon.component-DRWi1aVe.js";import{n as h,t as g}from"./iframe-BrTwVG2K.js";import{a as _,o as v,r as y,t as b}from"./a11y-outcome-CiARakld.js";import{i as x,n as S,t as C}from"./ref-CfuUseVs.js";import{n as w,t as T}from"./normalize-alert-type-C-qeRm_W.js";function E(){let e=0;for(let t=j.length-1;t>=0;t--){let n=j[t];n.style.setProperty(`--_stack-offset`,`${e}px`),e+=n.getBoundingClientRect().height+k}}function D(e){j.push(e),M??=new ResizeObserver(()=>E()),M.observe(e),j.length>A&&j[0].dispatchEvent(new CustomEvent(`dismiss`,{bubbles:!0,composed:!0,detail:{reason:`stack-limit`}})),E()}function O(e){let t=j.indexOf(e);t!==-1&&j.splice(t,1),M?.unobserve(e),e.style.removeProperty(`--_stack-offset`),E()}var k,A,j,M,N=e((()=>{k=12,A=3,j=[],M=null})),P,F,I=e((()=>{o(),u(),f(),N(),T(),m(),g(),l(),P=`informational`,F=class extends i{constructor(...e){super(...e),this.alertType=`informational`,this.leftIcon=!0,this.closeIcon=!0,this.action=!1,this.message=`Informational message.`,this.actionText=`Action`,this.actionHref=`#`,this.autoDismiss=!1,this.autoDismissDuration=8e3,this._isHovered=!1,this._isFocused=!1,this._dismissTimer=null,this._handleDismiss=e=>{this._stopDismissTimer(),this.dispatchEvent(new CustomEvent(`dismiss`,{bubbles:!0,composed:!0,detail:{reason:e}}))},this._handleCloseClick=()=>{this._handleDismiss(`user`)},this._handleActionClick=()=>{this.dispatchEvent(new CustomEvent(`action-click`,{bubbles:!0,composed:!0,detail:{href:this.actionHref}}))},this._handleMouseEnter=()=>{this._isHovered=!0,this._stopDismissTimer()},this._handleMouseLeave=()=>{this._isHovered=!1,this._startDismissTimer()},this._handleFocusIn=()=>{this._isFocused=!0,this._stopDismissTimer()},this._handleFocusOut=e=>{let t=e.relatedTarget;t&&(this.shadowRoot?.contains(t)||this.contains(t))||(this._isFocused=!1,this._startDismissTimer())},this._handleVisibilityChange=()=>{document.hidden?this._stopDismissTimer():this._startDismissTimer()}}static{this.styles=[p,r`
    ...
    `]}_getIconName(){switch(this.alertType){case`success`:return`check-circle`;case`error`:return`warning-circle`;case`caution`:return`warning`;default:return`info`}}_startDismissTimer(){this._stopDismissTimer(),!(!this.autoDismiss||this._isHovered||this._isFocused||document.hidden)&&(this._dismissTimer=setTimeout(()=>{this._handleDismiss(`timeout`)},this.autoDismissDuration))}_stopDismissTimer(){this._dismissTimer&&=(clearTimeout(this._dismissTimer),null)}connectedCallback(){super.connectedCallback(),this.hasAttribute(`role`)||this.setAttribute(`role`,`alert`),this.hasAttribute(`aria-live`)||this.setAttribute(`aria-live`,`assertive`),this.hasAttribute(`aria-atomic`)||this.setAttribute(`aria-atomic`,`true`),this.addEventListener(`mouseenter`,this._handleMouseEnter),this.addEventListener(`mouseleave`,this._handleMouseLeave),this.addEventListener(`focusin`,this._handleFocusIn),this.addEventListener(`focusout`,this._handleFocusOut),document.addEventListener(`visibilitychange`,this._handleVisibilityChange),this.setAttribute(`data-entering`,``),D(this),this._startDismissTimer(),requestAnimationFrame(()=>{requestAnimationFrame(()=>{this.removeAttribute(`data-entering`)})})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`mouseenter`,this._handleMouseEnter),this.removeEventListener(`mouseleave`,this._handleMouseLeave),this.removeEventListener(`focusin`,this._handleFocusIn),this.removeEventListener(`focusout`,this._handleFocusOut),document.removeEventListener(`visibilitychange`,this._handleVisibilityChange),O(this),this._stopDismissTimer()}updated(e){super.updated(e),(e.has(`autoDismiss`)||e.has(`autoDismissDuration`))&&this._startDismissTimer()}willUpdate(e){if(!e.has(`alertType`))return;let t=w(this.alertType,P);t!==this.alertType&&(this.alertType=t)}render(){return a`
      ...
      ${this.closeIcon?a`
          ...
          `:n}
    `}},d([c({type:String,reflect:!0,attribute:`alert-type`})],F.prototype,`alertType`,void 0),d([c({type:Boolean,attribute:`left-icon`})],F.prototype,`leftIcon`,void 0),d([c({type:Boolean,attribute:`close-icon`})],F.prototype,`closeIcon`,void 0),d([c({type:Boolean,reflect:!0})],F.prototype,`action`,void 0),d([c({type:String})],F.prototype,`message`,void 0),d([c({type:String,attribute:`action-text`})],F.prototype,`actionText`,void 0),d([c({type:String,attribute:`action-href`})],F.prototype,`actionHref`,void 0),d([c({type:Boolean,reflect:!0,attribute:`auto-dismiss`})],F.prototype,`autoDismiss`,void 0),d([c({type:Number,attribute:`auto-dismiss-duration`})],F.prototype,`autoDismissDuration`,void 0),F=d([s(`mms-toast`)],F)})),L=t({LayoutBehavior:()=>J,Overview:()=>U,PlaygroundStory:()=>Y,ResponsiveDemo:()=>X,__namedExportsOrder:()=>Z,default:()=>z});function R(){let e=W.value;if(!e)return;let{alertType:t,message:n}=K[G%K.length];G++;let r=document.createElement(`mms-toast`);r.setAttribute(`alert-type`,t),r.setAttribute(`message`,n),e.appendChild(r)}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q=e((()=>{o(),C(),I(),h(),_(),b(),z={title:`Feedback/Toast`,tags:[`!autodocs`]},B={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},V=`680px`,H=`960px`,U={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${H}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">

      <!-- Header -->
      <h1 style="${B.h1}">Toast</h1>
      <p style="${B.body} opacity: 0.85; max-width: ${V}; margin-bottom: 1.5rem;">
      ...
      <p style="${B.caption} background: rgba(59,130,246,0.06); border-left: 3px solid #3B82F6; padding: 0.75rem 1rem; border-radius: 0 6px 6px 0; text-align: left; opacity: 0.85; margin: 0 0 2rem;">
        Examples below have their real <code style="${B.monoSm}">position: fixed</code> flattened
        (<code style="${B.monoSm}">.docs-flat</code>) purely so variants render side-by-side for
      ...
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1.5rem;">
        Defaults to the <code style="${B.monoSm}">informational</code> type with a status icon and a close button.
      </p>
      ...
      <!-- Alert Types -->
      <h2 style="${B.h2}">Alert types</h2>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1.5rem;">
        Four semantic types: <code style="${B.monoSm}">informational</code> (default),
        <code style="${B.monoSm}">success</code>, <code style="${B.monoSm}">caution</code>, and
        <code style="${B.monoSm}">error</code>. Each pairs a distinct icon with its own accent color.
      </p>
      ...
      <!-- With an action -->
      <h2 style="${B.h2}">With an action</h2>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1.5rem;">
        Setting <code style="${B.monoSm}">action</code> to <code style="${B.monoSm}">true</code> adds an inline
      ...
      <h2 style="${B.h2}">Optional icon and close button</h2>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1.5rem;">
        <code style="${B.monoSm}">left-icon</code> and <code style="${B.monoSm}">close-icon</code> each default to
        <code style="${B.monoSm}">true</code> and can be turned off independently.
      </p>
      ...
      <!-- Dismissal -->
      <h2 style="${B.h2}">Dismissal</h2>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1.5rem;">
        The close button fires a <code style="${B.monoSm}">dismiss</code> event with
        <code style="${B.monoSm}">detail: { reason: 'user' }</code> — the host page owns removal from the DOM
        (e.g. <code style="${B.monoSm}">@dismiss=\${() => el.remove()}</code>); the component does not remove
        itself. <code style="${B.monoSm}">auto-dismiss</code> opts the toast into <em>also</em> dismissing on a
        timer (<code style="${B.monoSm}">reason: 'timeout'</code>), pausing on hover or keyboard focus — the same
        tested pattern as <code style="${B.monoSm}">mms-alert-banner</code>'s
        <code style="${B.monoSm}">autoDismiss</code>/<code style="${B.monoSm}">autoDismissDuration</code>
        (WCAG 2.2.1/2.2.2). Unlike Marina's <code style="${B.monoSm}">ds-toast</code> — whose JSDoc describes
      ...
      <div style="background: rgba(34, 197, 94, 0.08); border-left: 3px solid #22C55E; padding: 1rem 1.25rem; margin-bottom: 1.5rem; border-radius: 0 6px 6px 0;">
        <p style="${B.bodySm} margin: 0;">
          <strong>Why <code style="${B.monoSm}">role="alert"</code>, not <code style="${B.monoSm}">role="status"</code>?</strong>
          Toast reports the direct result of something the user just did — a save, a submission, an undo window —
          not ambient page status. Its implicit <code style="${B.monoSm}">aria-live="assertive"</code> interrupts
          to confirm that action immediately. Use <code style="${B.monoSm}">mms-alert-banner</code>
          (<code style="${B.monoSm}">role="status"</code>, polite) for non-interrupting general status instead.
        </p>
      </div>
      ...
      <ul style="${B.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        <li style="margin-bottom: 0.5rem;"><strong>On render:</strong> Announces immediately (interrupts) via <code style="${B.monoSm}">role="alert"</code> — message and action link text are read as content</li>
        <li style="margin-bottom: 0.5rem;"><strong>Status icon:</strong> Announced via its <code style="${B.monoSm}">aria-label</code> (e.g. "error toast"), not left silent as decorative</li>
  ...
  `},W=S(),G=0,K=[{alertType:`success`,message:`Your changes have been saved.`},{alertType:`caution`,message:`Your session will expire in 5 minutes.`},{alertType:`error`,message:`Something went wrong — please try again.`},{alertType:`informational`,message:`A new version of this form is available.`}],q={frame:`border: 2px dashed rgba(128,128,128,0.35); border-radius: 8px; padding: 2rem 1.5rem 1rem; position: relative; margin-bottom: 0.75rem;`,frameLabel:`position: absolute; top: -0.7rem; left: 1rem; background: var(--color-surface-default, #fff); padding: 0 0.5rem; font-size: 0.75rem; font-weight: 600; opacity: 0.6; text-transform: uppercase; letter-spacing: 0.05em;`,stackDemo:`position: relative; transform: translateZ(0); overflow: hidden; min-height: 13rem;`,caption:`font-size: 0.8125rem; opacity: 0.65; text-align: center; margin: 0.5rem 0 0;`,callout:e=>`background: ${e}0d; border-left: 3px solid ${e}; padding: 1rem 1.25rem; margin-bottom: 1.5rem; border-radius: 0 6px 6px 0;`,viewportBox:`border: 1px solid rgba(128,128,128,0.3); border-radius: 6px; padding: 1.25rem 1rem; background: rgba(128,128,128,0.03); display: flex; align-items: center; justify-content: center;`,widthRow:`margin: 0.75rem 12% 0; height: 1.125rem; border-top: 1px solid rgba(128,128,128,0.3); border-left: 1px solid rgba(128,128,128,0.3); border-right: 1px solid rgba(128,128,128,0.3); border-radius: 4px 4px 0 0; display: flex; align-items: flex-end; justify-content: center;`,widthLabel:`font-size: 0.75rem; opacity: 0.55; font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; transform: translateY(0.6rem); background: var(--color-surface-default, #fff); padding: 0 0.375rem; white-space: nowrap;`},J={name:`Layout & Behavior`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${H}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <!-- Placement -->
      <h2 style="${B.h2}">Placement</h2>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1rem;">
        Toast places itself in a <strong>fixed, bottom-center viewport stack</strong> —
        <code style="${B.monoSm}">:host</code> sets <code style="${B.monoSm}">position: fixed; bottom: 24px;</code>
        directly, with no consumer wrapper or manager element involved.
      </p>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1rem;">
        When more than one toast is connected, a shared registry
        (<code style="${B.monoSm}">src/utils/toast-stack.ts</code>) tracks every mounted
        <code style="${B.monoSm}">mms-toast</code> and writes a computed
        <code style="${B.monoSm}">--_stack-offset</code> custom property onto each one — newest-connected sits
        ...
        <code style="${B.monoSm}">ResizeObserver</code>, so a toast's message wrapping to a second line
        re-flows the whole stack automatically.
      </p>

      <div style="${q.frame}">
        <span style="${q.frameLabel}">Live demo — contained to this frame for docs purposes only</span>
        <div style="${q.stackDemo}" ${x(W)}>
          <mms-toast alert-type="success" message="Your application was submitted successfully."></mms-toast>
          <mms-toast alert-type="informational" message="A new version of this form is available."></mms-toast>
        </div>
      </div>
      <div style="display: flex; justify-content: center; margin-bottom: 0.75rem;">
        <mms-button variant="secondary" label="Trigger a toast" @click=${R}></mms-button>
      </div>
      <p style="${q.caption}">
        The two toasts above are real, currently-connected <code style="${B.monoSm}">mms-toast</code> elements —
        ...
        (via a CSS <code style="${B.monoSm}">transform</code>, which creates a containing block for
        <code style="${B.monoSm}">position: fixed</code> descendants) — in production, with no such override,
      ...
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1rem;">
        ...
        dispatches the same <code style="${B.monoSm}">dismiss</code> event a consumer already listens for, with
        <code style="${B.monoSm}">detail: { reason: 'stack-limit' }</code>, so eviction goes through the one
        removal path rather than a second one. The cap exists because every toast is
        <code style="${B.monoSm}">aria-live="assertive"</code> — past 3 simultaneous announcements, a screen
      ...
      <!-- Motion -->
      <h2 style="${B.h2}">Entrance &amp; reflow motion</h2>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1rem;">
        ...
        <code style="${B.monoSm}">:host</code> transitions <code style="${B.monoSm}">transform</code>
        and <code style="${B.monoSm}">opacity</code> whenever <code style="${B.monoSm}">--_stack-offset</code>
        changes, so there's nothing separate to configure for entrance vs. reflow. Duration and easing come from
        the structural motion tokens (<code style="${B.monoSm}">--motion-duration-slow</code>,
        <code style="${B.monoSm}">--motion-easing-standard</code>) — no per-instance motion props exist.
      </p>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1rem;">
        <code style="${B.monoSm}">prefers-reduced-motion: reduce</code> collapses all of this to
        <code style="${B.monoSm}">--motion-duration-instant</code> (0ms) automatically — layout still reflows
      ...
      <!-- Toast vs. Modal -->
      <h2 style="${B.h2}">Toast vs. modal</h2>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1rem;">
        Toast's <code style="${B.monoSm}">z-index</code> is <strong>1100</strong> — deliberately above
        <code style="${B.monoSm}">mms-modal</code>'s <strong>1000</strong>, so a toast started before a modal opens
        ...
        <code style="${B.monoSm}">aria-live</code> (WCAG 2.4.3). No consumer configuration is needed for this —
      ...
      <!-- Responsiveness -->
      <h2 style="${B.h2}">Responsiveness</h2>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1rem;">
      ...
      <ul style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin: 0 0 1rem; padding-left: 1.25rem;">
      ...
      <div style="display: flex; flex-direction: column; gap: 1.5rem; margin-bottom: 0.5rem;">
        ...
        <div style="width: 100%;">
          <div style="${q.frame}">
            <span style="${q.frameLabel}">≥ 768px viewport</span>
            <div style="${q.viewportBox}">
              <iframe
            ...
            <div style="${q.widthRow}"><span style="${q.widthLabel}">560px card, centered</span></div>
          </div>
          <p style="${q.caption}">Fixed width, centered at the bottom of the screen</p>
        </div>
        ...
        <div style="display: flex; gap: 1.5rem; align-items: flex-start;">
          ...
          <div style="flex: 1 1 60%; min-width: 0;">
            <div style="${q.frame}">
              <span style="${q.frameLabel}">340–767px viewport</span>
              <div style="${q.viewportBox}">
                <iframe
                  src="./iframe.html?id=feedback-toast--responsive-demo&viewMode=story"
              ...
              <div style="${q.widthRow}"><span style="${q.widthLabel}">full width, 20px inset</span></div>
            </div>
            <p style="${q.caption}">Stretches edge-to-edge, inset 20px each side</p>
          </div>

          <!-- Band 3: <340px, stacked, icon top-left -->
          <div style="flex: 1 1 40%; min-width: 0;">
            <div style="${q.frame}">
              <span style="${q.frameLabel}">&lt; 340px viewport</span>
              <div style="${q.viewportBox}">
                <iframe
                  src="./iframe.html?id=feedback-toast--responsive-demo&viewMode=story"
              ...
              <div style="${q.widthRow}"><span style="${q.widthLabel}">icon / message / close stacked</span></div>
            </div>
            <p style="${q.caption}">Icon top-left, message, close bottom-right</p>
          </div>

        </div>
      </div>
      <p style="${B.caption} opacity: 0.55; max-width: ${V}; margin-bottom: 1rem;">
        Every card above is the real <code style="${B.monoSm}">mms-toast</code> component, not a mockup — the two
        narrower bands run inside an <code style="${B.monoSm}">iframe</code> pinned to that literal pixel width, so
        their own <code style="${B.monoSm}">@media</code> breakpoint genuinely fires for that browsing context. You
      ...
      <h2 style="${B.h2}">UX Behavior — Dismissal</h2>
      <p style="${B.bodySm} opacity: 0.85; max-width: ${V}; margin-bottom: 1rem;">
        Manual dismiss (the close button) is the default and always available. Setting
        <code style="${B.monoSm}">auto-dismiss</code> opts a toast into <em>also</em> dismissing on a timer —
        <code style="${B.monoSm}">auto-dismiss-duration</code> controls the delay (default
        ...
        Both dismissal paths fire the same <code style="${B.monoSm}">dismiss</code> event, distinguished by
        <code style="${B.monoSm}">event.detail.reason</code> (<code style="${B.monoSm}">'user'</code> or
        <code style="${B.monoSm}">'timeout'</code>) — the component never removes itself from the DOM either way;
        the host page owns that.
      </p>

      <div style="${q.callout(`#F59E0B`)}">
        <p style="${B.bodySm} margin: 0;">
          <strong>Caution:</strong> avoid pairing <code style="${B.monoSm}">auto-dismiss</code> with
          <code style="${B.monoSm}">action</code> (e.g. "Undo") unless
          <code style="${B.monoSm}">auto-dismiss-duration</code> gives the user realistic time to read the
  ...
  `)}\n></mms-toast>`},language:`html`}},controls:{sort:`none`}},render:e=>a`
      ...
      ></mms-toast>
    `},X={name:`Responsive demo (internal)`,tags:[`!dev`],render:()=>a`
  ...
  render: () => html\`
    <mms-toast alert-type="informational" message="Your application was submitted successfully."></mms-toast>
  \`
}`,...X.parameters?.docs?.source}}},Z=[`Overview`,`LayoutBehavior`,`PlaygroundStory`,`ResponsiveDemo`]}));Q();export{J as LayoutBehavior,U as Overview,Y as PlaygroundStory,X as ResponsiveDemo,Z as __namedExportsOrder,z as default,Q as n,L as t};