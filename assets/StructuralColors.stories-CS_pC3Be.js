...
&lt;mms-button color-scheme="onyx"&gt;Submit&lt;/mms-button&gt;</pre>
  ...
  `},d={1:{purpose:`Page — body background`,hex:`#fcfcfc`},2:{purpose:`Surface — cards, sidebars, panels`,hex:`#f9f9f9`},3:{purpose:`Element — ghost button, list item default`,hex:`#f0f0f0`},4:{purpose:`Element hovered`,hex:`#e8e8e8`},5:{purpose:`Element pressed — selected item`,hex:`#e0e0e0`},6:{purpose:`Separator — dividers, card borders`,hex:`#a8a8a8`},7:{purpose:`Border — input borders, button outlines`,hex:`#808080`},8:{purpose:`Border hovered — emphasized outlines`,hex:`#6a6a6a`},9:{purpose:`Solid (anchor) — filled elements`,hex:`#606060`},10:{purpose:`Solid hovered`,hex:`#484848`},11:{purpose:`Text muted — placeholder, captions`,hex:`#303030`},12:{purpose:`Text — body, headings`,hex:`#1a1a1a`}},f={1:{purpose:`Page — body background`,hex:`#080808`},2:{purpose:`Surface — cards, sidebars, panels`,hex:`#151515`},3:{purpose:`Element — ghost button, list item default`,hex:`#1c1c1c`},4:{purpose:`Element hovered`,hex:`#232323`},5:{purpose:`Element pressed — selected item`,hex:`#2c2c2c`},6:{purpose:`Separator — dividers, card borders`,hex:`#4a4a4a`},7:{purpose:`Border — input borders, button outlines`,hex:`#6a6a6a`},8:{purpose:`Border hovered — emphasized outlines`,hex:`#858585`},9:{purpose:`Solid (anchor) — filled elements`,hex:`#979797`},10:{purpose:`Solid hovered`,hex:`#b0b0b0`},11:{purpose:`Text muted — placeholder, captions`,hex:`#c7c7c7`},12:{purpose:`Text — body, headings`,hex:`#e3e3e3`}},p={name:`Neutral`,render:()=>t`
