import{a as e,i as t}from"./preload-helper-BdFrVu1K.js";import{d as n,i as r,n as i,o as a,t as o}from"./iframe-CQ36wFM3.js";import{a as s,c,i as l,n as u,o as d,r as f,t as p,u as m}from"./mms-icon.component-DvMzcxI2.js";var h,g=t((()=>{o(),d(),s(),p(),f(),h=class extends i{constructor(...e){super(...e),this.variant=`primary`,this.colorScheme=`primary`,this.size=`md`,this.roundness=`subtle`,this.state=`default`,this.disabled=!1,this.label=``,this.leftIcon=``,this.rightIcon=``,this._handleKeyDown=e=>{this.disabled||(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.click())}}static{this.styles=[l,n`
      /* ═══════════════════════════════════════════════════════════════════════
...
&lt;mms-button variant="ghost" label="Learn more"&gt;&lt;/mms-button&gt;</code></pre>
  ...
  `},D={tags:[`!dev`],args:{variant:`primary`,size:`md`,roundness:`subtle`,state:`default`,disabled:!1,label:`Button`,leftIcon:``,rightIcon:``,colorScheme:`primary`,theme:`maximus`,density:`default`},decorators:[e=>a`
        <div
          style="
            min-height: 80px;
            display: flex;
  ...
  label="${n.label}"${i}${a}${o}
></mms-button>`},language:`html`}}},render:e=>_(e.theme,e.colorScheme)?a`
      <mms-button
        variant=${e.variant}
