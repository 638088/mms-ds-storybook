import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{s as n,t as r}from"./lit-aQ4dERgF.js";import{n as i,t as a}from"./theme-constraints-BagCRQzo.js";import{t as o}from"./mms-checkbox.component-BExBeeLA.js";var s=t({Overview:()=>f,PlaygroundStory:()=>p,__namedExportsOrder:()=>m,default:()=>c}),c,l,u,d,f,p,m,h=e((()=>{r(),o(),a(),c={title:`Forms/Checkbox`,tags:[`!autodocs`]},l={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},u=`680px`,d=`960px`,f={name:`Overview`,render:()=>n`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${d}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <p style="${l.bodySm} opacity: 0.85; max-width: ${u}; margin-bottom: 1.5rem;">
        The <code style="${l.monoSm}">color-scheme</code> prop controls which color palette the checkbox uses when checked.
      </p>
      ...
      <p style="${l.bodySm} opacity: 0.85; max-width: ${u}; margin-bottom: 1.5rem;">
        When <code style="${l.monoSm}">required</code> is set, an asterisk appears on the highest-level label. If a heading is present, the asterisk shows there; otherwise it appears on the checkbox label.
      </p>
      ...
      <h2 style="${l.h2}">Checkbox only</h2>
      <p style="${l.bodySm} opacity: 0.85; max-width: ${u}; margin-bottom: 1.5rem;">
      ...
      <p style="${l.bodySm} opacity: 0.85; max-width: ${u}; margin-bottom: 1.5rem;">
        Checkboxes follow WAI-ARIA Checkbox pattern for full keyboard and screen reader support.
      </p>
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 2rem; font-size: 0.875rem;">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            ...
            <td style="padding: 0.75rem 1rem;"><code style="${l.monoSm}">role="checkbox"</code> with <code style="${l.monoSm}">aria-checked</code> reflecting checked/indeterminate state</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            <td style="padding: 0.75rem 1rem; font-weight: 500;">Keyboard</td>
            <td style="padding: 0.75rem 1rem;"><kbd style="padding: 0.125rem 0.375rem; background: rgba(128,128,128,0.1); border-radius: 3px; font-size: 0.75rem;">Space</kbd> toggles selection; <kbd style="padding: 0.125rem 0.375rem; background: rgba(128,128,128,0.1); border-radius: 3px; font-size: 0.75rem;">Tab</kbd> moves focus between checkboxes</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            <td style="padding: 0.75rem 1rem; font-weight: 500;">Focus</td>
            <td style="padding: 0.75rem 1rem;">Visible focus ring using <code style="${l.monoSm}">--focus-ring-*</code> tokens</td>
          </tr>
          <tr>
            <td style="padding: 0.75rem 1rem; font-weight: 500;">Labels</td>
            <td style="padding: 0.75rem 1rem;">Associated via <code style="${l.monoSm}">aria-labelledby</code> or visible <code style="${l.monoSm}">label</code> prop</td>
          </tr>
        </tbody>
      </table>

    </div>
  `},p={name:`Playground`,tags:[`!dev`],args:{label:`I agree to the terms`,checked:!1,indeterminate:!1,colorScheme:`primary`,size:`md`,state:`default`,readonly:!1,disabled:!1,error:!1,errorText:`This field is required`,required:!1,heading:``,helperText:``,fieldName:``,checkedValue:`on`,theme:`maximus`},decorators:[e=>n`
        <div
          style="
            min-height: 120px;
            display: flex;
  ...
  `)}\n></mms-checkbox>`},language:`html`}}},render:e=>i(e.theme,e.colorScheme)?n`
      <mms-checkbox
        label=${e.label}
        ?checked=${e.checked}
    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: \${PAGE_MAX}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 2rem; font-size: 0.875rem;">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            <td style="padding: 0.75rem 1rem; font-weight: 500;">ARIA</td>
            <td style="padding: 0.75rem 1rem;"><code style="\${t.monoSm}">role="checkbox"</code> with <code style="\${t.monoSm}">aria-checked</code> reflecting checked/indeterminate state</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            <td style="padding: 0.75rem 1rem; font-weight: 500;">Keyboard</td>
            <td style="padding: 0.75rem 1rem;"><kbd style="padding: 0.125rem 0.375rem; background: rgba(128,128,128,0.1); border-radius: 3px; font-size: 0.75rem;">Space</kbd> toggles selection; <kbd style="padding: 0.125rem 0.375rem; background: rgba(128,128,128,0.1); border-radius: 3px; font-size: 0.75rem;">Tab</kbd> moves focus between checkboxes</td>
          ...
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            <td style="padding: 0.75rem 1rem; font-weight: 500;">Focus</td>
            <td style="padding: 0.75rem 1rem;">Visible focus ring using <code style="\${t.monoSm}">--focus-ring-*</code> tokens</td>
          </tr>
          <tr>
            <td style="padding: 0.75rem 1rem; font-weight: 500;">Labels</td>
