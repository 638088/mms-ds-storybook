import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,n as r,p as i,s as a,t as o}from"./lit-aQ4dERgF.js";import{a as s,f as c,i as l,m as u,n as d,o as f,r as p,s as m,t as h}from"./decorate-CFSc4vnv.js";import{n as g,t as _}from"./validate-color-scheme-Du8WhLEN.js";import{t as v}from"./mms-icon.component-Cz1Jc6Sy.js";import{n as y}from"./iframe-DQXT9Zip.js";import{n as b,r as x,t as S}from"./theme-constraints-D-yar-OC.js";import{a as C,o as w,r as T,t as E}from"./a11y-outcome-DlWsiEtn.js";import{i as D,n as O,t as k}from"./ref-CqhPkrLh.js";import{t as ee}from"./mms-text-field.component-3yaqCCF4.js";var A,j,M=e((()=>{o(),f(),s(),_(),v(),y(),d(),A=[`a[href]`,`button:not([disabled])`,`input:not([disabled])`,`select:not([disabled])`,`textarea:not([disabled])`,`[tabindex]:not([tabindex="-1"])`,`mms-button:not([disabled])`,`mms-link`,`mms-text-field:not([disabled])`].join(`,`),j=class extends r{constructor(...e){super(...e),this.size=`xl`,this.open=!1,this.titleText=``,this.description=!0,this.descText=``,this.closeIcon=!0,this.primaryLabel=`Confirm`,this.secondaryLabel=`Cancel`,this.tertiaryLabel=``,this.colorScheme=`onyx`,this._previouslyFocused=null,this._boundEscapeKeyDown=this._handleEscapeKeyDown.bind(this),this._boundFocusTrapKeyDown=this._handleFocusTrapKeyDown.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this._boundEscapeKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this._boundEscapeKeyDown),document.removeEventListener(`keydown`,this._boundFocusTrapKeyDown)}firstUpdated(){g(this,this.colorScheme,`mms-modal`)}updated(e){super.updated(e),e.has(`open`)&&(this.open?this._activateFocusTrap():this._deactivateFocusTrap())}_handleEscapeKeyDown(e){this.open&&e.key===`Escape`&&this._handleClose(`escape-key`)}_getFocusableElements(){if(!this._dialogEl)return[];let e=Array.from(this._dialogEl.querySelectorAll(A)),t=this.shadowRoot?.querySelector(`slot`),n=(t?t.assignedElements({flatten:!0}):[]).flatMap(e=>e.matches(A)?[e]:Array.from(e.querySelectorAll(A)));return[...e,...n].filter(e=>{let t=getComputedStyle(e);return t.display!==`none`&&t.visibility!==`hidden`})}_activateFocusTrap(){this._previouslyFocused=document.activeElement,document.addEventListener(`keydown`,this._boundFocusTrapKeyDown),requestAnimationFrame(()=>{this._getFocusableElements()[0]?.focus()})}_deactivateFocusTrap(){document.removeEventListener(`keydown`,this._boundFocusTrapKeyDown),this._previouslyFocused?.focus(),this._previouslyFocused=null}_handleFocusTrapKeyDown(e){if(e.key!==`Tab`)return;let t=this._getFocusableElements();if(t.length===0)return;let n=t[0],r=t[t.length-1],i=this.shadowRoot?.activeElement;e.shiftKey&&i===n?(e.preventDefault(),r.focus()):!e.shiftKey&&i===r&&(e.preventDefault(),n.focus())}_handleClose(e){this.open=!1,this.dispatchEvent(new CustomEvent(`close`,{detail:{source:e},bubbles:!0,composed:!0}))}_handleOverlayClick(e){e.target===e.currentTarget&&this._handleClose(`overlay-click`)}_handlePrimaryClick(){this.dispatchEvent(new CustomEvent(`primary-click`,{bubbles:!0,composed:!0}))}_handleSecondaryClick(){this.dispatchEvent(new CustomEvent(`secondary-click`,{bubbles:!0,composed:!0})),this._handleClose(`secondary-button`)}_handleTertiaryClick(){this.dispatchEvent(new CustomEvent(`tertiary-click`,{bubbles:!0,composed:!0}))}_renderFooter(){return a`
    ...
    `]}},h([c({type:String,reflect:!0})],j.prototype,`size`,void 0),h([c({type:Boolean,reflect:!0})],j.prototype,`open`,void 0),h([c({type:String,attribute:`title-text`})],j.prototype,`titleText`,void 0),h([c({type:Boolean})],j.prototype,`description`,void 0),h([c({type:String,attribute:`desc-text`})],j.prototype,`descText`,void 0),h([c({type:Boolean,attribute:`close-icon`})],j.prototype,`closeIcon`,void 0),h([c({type:String,attribute:`primary-label`})],j.prototype,`primaryLabel`,void 0),h([c({type:String,attribute:`secondary-label`})],j.prototype,`secondaryLabel`,void 0),h([c({type:String,attribute:`tertiary-label`})],j.prototype,`tertiaryLabel`,void 0),h([c({type:String,reflect:!0,attribute:`color-scheme`})],j.prototype,`colorScheme`,void 0),h([m(`.dialog`)],j.prototype,`_dialogEl`,void 0),j=h([u(`mms-modal`)],j)})),N=t({Overview:()=>X,PlaygroundStory:()=>Z,__namedExportsOrder:()=>Q,default:()=>I});function P(e){e.value&&(e.value.open=!0)}function F(e,t){if(J.has(e))return;J.add(e);let n=()=>{let n=e.shadowRoot?.querySelector(`.overlay`),r=e.shadowRoot?.querySelector(`.header`),i=e.shadowRoot?.querySelector(`.body`),a=e.shadowRoot?.querySelector(`.footer`);if(!n||!r||!i||!a)return;let o=parseFloat(getComputedStyle(n).paddingTop)||0,s=(r.getBoundingClientRect().height+i.scrollHeight+a.getBoundingClientRect().height)/.8+o*2;t.style.height=`${Math.ceil(Math.min(s,Y))}px`},r=new ResizeObserver(n),i=e.shadowRoot?.querySelector(`.content-frame`);i&&r.observe(i);let a=e.shadowRoot?.querySelector(`.header`);a&&r.observe(a);let o=e.shadowRoot?.querySelector(`.footer`);o&&r.observe(o),new MutationObserver(n).observe(e,{attributes:!0,attributeFilter:[`size`]}),n()}var I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{o(),k(),M(),y(),ee(),b(),C(),E(),I={title:`Feedback/Modal`,tags:[`!autodocs`],parameters:{layout:`fullscreen`}},L={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},R=`680px`,z=`960px`,B=O(),V=O(),H=O(),U=O(),W=O(),G=O(),K=O(),q=O(),J=new WeakSet,Y=900,X={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${z}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <!-- Sizes -->
      <h2 style="${L.h2}">Sizes</h2>
      <p style="${L.bodySm} opacity: 0.85; max-width: ${R}; margin-bottom: 1.5rem;">
        Four sizes control the dialog's max-width: <code style="${L.monoSm}">xl</code> (default, 1140px),
        <code style="${L.monoSm}">lg</code> (800px), <code style="${L.monoSm}">md</code> (640px),
        and <code style="${L.monoSm}">sm</code> (320px). <code style="${L.monoSm}">sm</code>
      ...
      <div style="display: flex; gap: 1rem; flex-wrap: wrap; margin-bottom: 2rem;">
        ...
        <mms-modal ${D(V)} size="xl" title-text="XL (1140px)" desc-text="Used for content-rich dialogs."></mms-modal>

        <mms-button variant="secondary" label="Open lg" @click=${()=>P(H)}></mms-button>
        <mms-modal ${D(H)} size="lg" title-text="LG (800px)" desc-text="Used for standard forms and decisions."></mms-modal>

        <mms-button variant="secondary" label="Open md" @click=${()=>P(U)}></mms-button>
        <mms-modal ${D(U)} size="md" title-text="MD (640px)" desc-text="Used for shorter confirmations."></mms-modal>

        <mms-button variant="secondary" label="Open sm" @click=${()=>P(W)}></mms-button>
        <mms-modal ${D(W)} size="sm" title-text="Are you sure?" desc-text="Full-width stacked actions." primary-label="Confirm" secondary-label="Cancel"></mms-modal>
      </div>

      <hr style="border: none; border-top: 1px solid rgba(128,128,128,0.15); margin: 0 0 2rem;" />

      <!-- Tertiary Action -->
      <h2 style="${L.h2}">Tertiary action</h2>
      <p style="${L.bodySm} opacity: 0.85; max-width: ${R}; margin-bottom: 1.5rem;">
        Setting <code style="${L.monoSm}">tertiary-label</code> adds a ghost-variant action, left-aligned
      ...
      <!-- Without close icon -->
      <h2 style="${L.h2}">Without the close icon</h2>
      <p style="${L.bodySm} opacity: 0.85; max-width: ${R}; margin-bottom: 1.5rem;">
        <code style="${L.monoSm}">close-icon</code> defaults to <code style="${L.monoSm}">true</code>.
        To hide it, set the <code style="${L.monoSm}">closeIcon</code> property to <code style="${L.monoSm}">false</code>
        directly (e.g. <code style="${L.monoSm}">el.closeIcon = false</code> or a template's
        <code style="${L.monoSm}">.closeIcon=\${false}</code> binding) — as a boolean property, its plain-HTML
        attribute form has no falsy representation, so <code style="${L.monoSm}">close-icon="false"</code>
      ...
      <div style="background: rgba(34, 197, 94, 0.08); border-left: 3px solid #22C55E; padding: 1rem 1.25rem; margin-bottom: 1.5rem; border-radius: 0 6px 6px 0;">
        <p style="${L.bodySm} margin: 0;">
          ...
          "standard exit method" exception, so <code style="${L.monoSm}">mms-modal</code> always closes
      ...
      <ul style="${L.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        ...
        <li style="margin-bottom: 0.5rem;"><strong>Description:</strong> Read automatically as part of the dialog's accessible description via <code style="${L.monoSm}">aria-describedby</code></li>
  ...
  `)}\n>`;return n.richContent?`${i}\n  <mms-text-field label="Street address"></mms-text-field>\n</mms-modal>`:`${i}\n</mms-modal>`},language:`html`}},controls:{sort:`none`}},render:e=>{let t=O(),r=O();queueMicrotask(async()=>{let e=t.value,n=r.value;!e||!n||(await e.updateComplete,F(e,n))});let i=x(e.theme,e.colorScheme),o=S(e.theme,e.colorScheme);if(!i){let t=o===2?`Tier 2 (Text + Surface)`:`Tier 3 (Decorative)`,n=o===2?`Lacks step 10 (hover state). Use for branded text or badges, not interactive footer buttons.`:`Lacks text contrast and hover states. Decorative backgrounds only.`;return a`
        <div style="
          display: flex;
          align-items: center;
          justify-content: center;
      ...
      >
        ...
        >
          ${e.richContent?a`
                <mms-text-field label="Street address"></mms-text-field>
                <p style="${L.caption} margin-top: 0.5rem; opacity: 0.6; font-style: italic;">
