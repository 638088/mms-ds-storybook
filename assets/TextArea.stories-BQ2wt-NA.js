import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,n as r,p as i,s as a,t as o}from"./lit-aQ4dERgF.js";import{a as s,f as c,m as l,n as u,o as d,r as f,t as p}from"./decorate-CFSc4vnv.js";import{t as m}from"./mms-icon.component-Cz1Jc6Sy.js";var h,g=e((()=>{o(),d(),s(),m(),u(),h=class extends r{constructor(...e){super(...e),this.size=`md`,this.state=`default`,this.disabled=!1,this.readonly=!1,this.resize=`vertical`,this._rows=3,this.label=``,this.placeholder=``,this.helperText=``,this.name=``,this.value=``,this.required=!1,this.error=!1,this.errorText=``,this.maxLength=0,this.showCharacterCounter=!1,this.showTooltip=!1,this.tooltipText=``}get rows(){return this._rows}set rows(e){let t=this._rows;this._rows=Math.min(15,Math.max(2,e)),this.requestUpdate(`rows`,t)}get ariaDescribedBy(){let e=[];return this.helperText&&!this.error&&e.push(`helper-text`),this.error&&this.errorText&&e.push(`error-text`),this.showCharacterCounter&&this.maxLength>0&&e.push(`char-counter`),e.join(` `)||void 0}get charsRemaining(){return this.maxLength-this.value.length}static{this.styles=[f,i`
    ...
    `]}_handleInput(e){if(this.disabled||this.readonly)return;let t=e.target,n=this.value,r=t.value;this.maxLength>0&&r.length>this.maxLength&&(r=r.slice(0,this.maxLength),t.value=r),this.value=r,this.dispatchEvent(new CustomEvent(`input`,{detail:{value:this.value,oldValue:n},bubbles:!0,composed:!0}))}_handleFocus(){this.disabled||(this.state=`focus`,this.dispatchEvent(new CustomEvent(`focus`,{detail:{value:this.value},bubbles:!0,composed:!0})))}_handleBlur(){this.disabled||(this.state=this.value?`filled`:`default`,this.dispatchEvent(new CustomEvent(`blur`,{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`change`,{detail:{value:this.value},bubbles:!0,composed:!0})))}render(){return a`
      ...
      ${this.error&&this.errorText&&!this.disabled?a`
          ...
          `:n}
    `}},p([c({type:String,reflect:!0})],h.prototype,`size`,void 0),p([c({type:String,reflect:!0})],h.prototype,`state`,void 0),p([c({type:Boolean,reflect:!0})],h.prototype,`disabled`,void 0),p([c({type:Boolean,reflect:!0})],h.prototype,`readonly`,void 0),p([c({type:String,reflect:!0})],h.prototype,`resize`,void 0),p([c({type:Number})],h.prototype,`rows`,null),p([c({type:String})],h.prototype,`label`,void 0),p([c({type:String})],h.prototype,`placeholder`,void 0),p([c({type:String,attribute:`helper-text`})],h.prototype,`helperText`,void 0),p([c({type:String})],h.prototype,`name`,void 0),p([c({type:String,reflect:!0})],h.prototype,`value`,void 0),p([c({type:Boolean,reflect:!0})],h.prototype,`required`,void 0),p([c({type:Boolean,reflect:!0})],h.prototype,`error`,void 0),p([c({type:String,attribute:`error-text`})],h.prototype,`errorText`,void 0),p([c({type:Number,attribute:`max-length`})],h.prototype,`maxLength`,void 0),p([c({type:Boolean,attribute:`show-character-counter`})],h.prototype,`showCharacterCounter`,void 0),p([c({type:Boolean,reflect:!0,attribute:`show-tooltip`})],h.prototype,`showTooltip`,void 0),p([c({type:String,attribute:`tooltip-text`})],h.prototype,`tooltipText`,void 0),h=p([l(`mms-text-area`)],h)})),_=t({Overview:()=>S,PlaygroundStory:()=>C,__namedExportsOrder:()=>w,default:()=>v}),v,y,b,x,S,C,w,T=e((()=>{o(),g(),v={title:`Forms/Text Area`,tags:[`!autodocs`]},y={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},b=`680px`,x=`960px`,S={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${x}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <!-- Character Counter -->
      <h2 style="${y.h2}">Character counter</h2>
      <p style="${y.bodySm} opacity: 0.85; max-width: ${b}; margin-bottom: 1.5rem;">
        Set <code style="${y.monoSm}">max-length</code> and <code style="${y.monoSm}">show-character-counter</code>
      ...
      <!-- Rows and Resize -->
      <h2 style="${y.h2}">Rows and resize behavior</h2>
      <p style="${y.bodySm} opacity: 0.85; max-width: ${b}; margin-bottom: 1.5rem;">
        The <code style="${y.monoSm}">rows</code> prop sets the initial visible height.
        <code style="${y.monoSm}">resize</code> controls whether the user can drag-resize vertically
        (<code style="${y.monoSm}">vertical</code>, default) or not at all (<code style="${y.monoSm}">none</code>).
      </p>
      ...
      <p style="${y.bodySm} opacity: 0.85; max-width: ${b}; margin-bottom: 1.5rem;">
        ...
        Consistent with <code style="${y.monoSm}">mms-text-field</code> sizing.
      </p>
      ...
      <div style="width: 240px; background: rgba(128,128,128,0.1); padding: 1rem; border-radius: 8px; margin-bottom: 2rem;">
        <p style="${y.caption} margin-bottom: 0.25rem;"><strong>Narrow container (240px)</strong></p>
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; font-size: 0.875rem;">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            ...
            <td style="padding: 0.5rem 0.75rem;">Visible label linked via <code style="${y.monoSm}">aria-label</code> and <code style="${y.monoSm}">aria-describedby</code></td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
          ...
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            ...
            <td style="padding: 0.5rem 0.75rem;">Minimum height well above threshold (default 3 rows + padding)</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
          ...
          <tr>
            ...
            <td style="padding: 0.5rem 0.75rem;">Native &lt;textarea&gt; + <code style="${y.monoSm}">aria-invalid</code>, native <code style="${y.monoSm}">required</code></td>
          </tr>
        </tbody>
      </table>
      ...
      <ul style="${y.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        ...
        <li style="margin-bottom: 0.5rem;"><strong>Character counter:</strong> Announces remaining characters via <code style="${y.monoSm}">aria-live="polite"</code> as the user types</li>
  ...
  `},C={name:`Playground`,tags:[`!dev`],args:{size:`md`,state:`default`,disabled:!1,readonly:!1,resize:`vertical`,rows:3,label:`Comments`,placeholder:`Enter your comments...`,helperText:``,name:`myTextArea`,value:``,required:!1,error:!1,errorText:`This field is required.`,maxLength:0,showCharacterCounter:!1,showTooltip:!1,tooltipText:`Additional guidance for this field`,theme:`maximus`,density:`default`},decorators:[e=>a`
        <div
          style="
            display: flex;
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; font-size: 0.875rem;">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            <td style="padding: 0.5rem 0.75rem;"><strong>1.3.1</strong> Info & Relationships</td>
            <td style="padding: 0.5rem 0.75rem;">Programmatic label association</td>
            <td style="padding: 0.5rem 0.75rem;">Visible label linked via <code style="\${t.monoSm}">aria-label</code> and <code style="\${t.monoSm}">aria-describedby</code></td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            <td style="padding: 0.5rem 0.75rem;"><strong>1.4.11</strong> Non-text Contrast</td>
            <td style="padding: 0.5rem 0.75rem;">3:1 for UI components</td>
          ...
          <tr>
            <td style="padding: 0.5rem 0.75rem;"><strong>4.1.2</strong> Name, Role, Value</td>
            <td style="padding: 0.5rem 0.75rem;">Accessible name and state</td>
            <td style="padding: 0.5rem 0.75rem;">Native &lt;textarea&gt; + <code style="\${t.monoSm}">aria-invalid</code>, native <code style="\${t.monoSm}">required</code></td>
          </tr>
        </tbody>
      </table>
...
}`,...C.parameters?.docs?.source}}},w=[`Overview`,`PlaygroundStory`]}));T();export{S as Overview,C as PlaygroundStory,w as __namedExportsOrder,v as default,T as n,_ as t};