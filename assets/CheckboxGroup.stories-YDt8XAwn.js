import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,n as r,p as i,s as a,t as o}from"./lit-aQ4dERgF.js";import{a as s,d as c,l,n as u,t as d}from"./decorate-ClfqJe3w.js";import{n as f,t as p}from"./theme-constraints-BagCRQzo.js";import{t as m}from"./mms-checkbox.component-BExBeeLA.js";var h,g=e((()=>{o(),s(),m(),u(),h=class extends r{constructor(...e){super(...e),this.label=``,this.helperText=``,this.name=``,this.showTooltip=!1,this.tooltipText=``,this.colorScheme=`primary`,this.size=`md`,this.disabled=!1,this.readonly=!1,this.error=!1,this.errorText=``,this.required=!1}static{this.styles=i`
    /* ═══════════════════════════════════════════════════════════════════════
       HOST
       ═══════════════════════════════════════════════════════════════════════ */
    :host {
  ...
  `}_propagateToCheckboxes(){let e=this.shadowRoot?.querySelector(`slot`);e&&e.assignedElements({flatten:!0}).filter(e=>e.tagName===`MMS-CHECKBOX`).forEach(e=>{e.setAttribute(`color-scheme`,this.colorScheme),e.setAttribute(`size`,this.size),this.disabled?e.setAttribute(`disabled`,``):e.removeAttribute(`disabled`),this.readonly?e.setAttribute(`readonly`,``):e.removeAttribute(`readonly`),this.name&&e.setAttribute(`field-name`,this.name)})}_handleSlotChange(){this._propagateToCheckboxes()}updated(e){super.updated(e),(e.has(`colorScheme`)||e.has(`size`)||e.has(`disabled`)||e.has(`readonly`)||e.has(`name`))&&this._propagateToCheckboxes()}render(){return a`
      ...
      ${this.error&&this.errorText?a`
          ...
          `:n}
    `}},d([l({type:String})],h.prototype,`label`,void 0),d([l({type:String,attribute:`helper-text`})],h.prototype,`helperText`,void 0),d([l({type:String})],h.prototype,`name`,void 0),d([l({type:Boolean,reflect:!0,attribute:`show-tooltip`})],h.prototype,`showTooltip`,void 0),d([l({type:String,attribute:`tooltip-text`})],h.prototype,`tooltipText`,void 0),d([l({type:String,reflect:!0,attribute:`color-scheme`})],h.prototype,`colorScheme`,void 0),d([l({type:String,reflect:!0})],h.prototype,`size`,void 0),d([l({type:Boolean,reflect:!0})],h.prototype,`disabled`,void 0),d([l({type:Boolean,reflect:!0})],h.prototype,`readonly`,void 0),d([l({type:Boolean,reflect:!0})],h.prototype,`error`,void 0),d([l({type:String,attribute:`error-text`})],h.prototype,`errorText`,void 0),d([l({type:Boolean,reflect:!0})],h.prototype,`required`,void 0),h=d([c(`mms-checkbox-group`)],h)})),_=t({Overview:()=>S,PlaygroundStory:()=>C,__namedExportsOrder:()=>w,default:()=>v}),v,y,b,x,S,C,w,T=e((()=>{o(),g(),m(),p(),v={title:`Forms/Checkbox Group`,tags:[`!autodocs`]},y={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},b=`680px`,x=`960px`,S={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${x}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <!-- Header -->
      <h1 style="${y.h1}">Checkbox Group</h1>
      ...
      <p style="${y.bodySm} opacity: 0.85; max-width: ${b}; margin-bottom: 1.5rem;">
        Wrap multiple <code style="${y.monoSm}">&lt;mms-checkbox&gt;</code> elements inside a group 
        with a shared label.
      </p>
      ...
      <!-- Required Group -->
      <h2 style="${y.h2}">Required group</h2>
      <p style="${y.bodySm} opacity: 0.85; max-width: ${b}; margin-bottom: 1.5rem;">
      ...
      <p style="${y.bodySm} opacity: 0.85; max-width: ${b}; margin-bottom: 1.5rem;">
        The <code style="${y.monoSm}">error</code> prop displays validation feedback for the entire group.
      ...
      <!-- Color Schemes -->
      <h2 style="${y.h2}">Color schemes</h2>
      <p style="${y.bodySm} opacity: 0.85; max-width: ${b}; margin-bottom: 1.5rem;">
        The <code style="${y.monoSm}">color-scheme</code> prop propagates to all child checkboxes.
      </p>
      ...
      <!-- Sizes -->
      <h2 style="${y.h2}">Sizes</h2>
      <p style="${y.bodySm} opacity: 0.85; max-width: ${b}; margin-bottom: 1.5rem;">
        The <code style="${y.monoSm}">size</code> prop propagates to all child checkboxes.
      </p>
      ...
      <!-- Disabled & Readonly -->
      <h2 style="${y.h2}">Disabled &amp; read-only</h2>
      <p style="${y.bodySm} opacity: 0.85; max-width: ${b}; margin-bottom: 1.5rem;">
  ...
  `)}\n>\n${i.join(`
`)}\n</mms-checkbox-group>`},language:`html`}}},render:e=>{if(!f(e.theme,e.colorScheme))return a`
        <div style="
          padding: 1.5rem 2rem;
          background: #fef2f2;
