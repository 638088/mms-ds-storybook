import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{s as n,t as r}from"./lit-aQ4dERgF.js";import{n as i,t as a}from"./theme-constraints-BagCRQzo.js";import{t as o}from"./mms-radio.component-B9Y95iX6.js";var s=t({Overview:()=>f,PlaygroundStory:()=>p,__namedExportsOrder:()=>m,default:()=>c}),c,l,u,d,f,p,m,h=e((()=>{r(),o(),a(),c={title:`Forms/Radio`,tags:[`!autodocs`]},l={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},u=`680px`,d=`960px`,f={name:`Overview`,render:()=>n`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${d}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <!-- Header -->
      <h1 style="${l.h1}">Radio</h1>
      <p style="${l.body} opacity: 0.85; max-width: ${u}; margin-bottom: 2rem;">
      ...
      ">
        <p style="${l.bodySm} margin: 0;">
          <strong>Usage:</strong> Radio buttons should be used within <code style="${l.monoSm}">&lt;mms-radio-group&gt;</code> which handles single-selection behavior and arrow key navigation. This page documents individual radio button props.
        </p>
      </div>
      ...
      <!-- States -->
      <h2 style="${l.h2}">Selection states</h2>
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 2rem;">
        <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px; display: flex; flex-direction: column;">
          <p style="${l.h3}">Unselected</p>
          <p style="${l.bodySm} opacity: 0.85; flex: 1;">
      ...
      <!-- Color Schemes -->
      <h2 style="${l.h2}">Color schemes</h2>
      <p style="${l.bodySm} opacity: 0.85; max-width: ${u}; margin-bottom: 1.5rem;">
        The <code style="${l.monoSm}">color-scheme</code> prop controls which color palette the radio uses when selected.
      </p>

      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 2rem;">
        <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px;">
          <p style="${l.h3}">Primary &amp; Secondary</p>
          <p style="${l.bodySm} opacity: 0.85; margin-bottom: 1rem;">
      ...
      <!-- With Helper Text -->
      <h2 style="${l.h2}">With helper text</h2>
      <p style="${l.bodySm} opacity: 0.85; max-width: ${u}; margin-bottom: 1.5rem;">
      ...
      <!-- Required Indicator -->
      <h2 style="${l.h2}">Required indicator</h2>
      <p style="${l.bodySm} opacity: 0.85; max-width: ${u}; margin-bottom: 1.5rem;">
        When <code style="${l.monoSm}">required</code> is set, an asterisk appears on the highest-level label. If a heading is present, the asterisk shows there; otherwise it appears on the radio label.
      </p>

      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 2rem;">
        <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px;">
          <p style="${l.h3}">With heading</p>
          <p style="${l.bodySm} opacity: 0.85; margin-bottom: 1rem;">
        ...
        <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px;">
          <p style="${l.h3}">Without heading</p>
          <p style="${l.bodySm} opacity: 0.85; margin-bottom: 1rem;">
      ...
      <!-- Disabled & Readonly -->
      <h2 style="${l.h2}">Disabled &amp; read-only</h2>

      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 2rem;">
        <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px;">
          <p style="${l.h3}">Disabled</p>
          <p style="${l.bodySm} opacity: 0.85; margin-bottom: 1rem;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; font-size: 0.875rem;">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            ...
            <td style="padding: 0.5rem 0.75rem;">Label linked via <code style="${l.monoSm}">aria-labelledby</code> or implicit association</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            ...
            <td style="padding: 0.5rem 0.75rem;">Radio border meets 3.3:1 against surface background</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            ...
            <td style="padding: 0.5rem 0.75rem;">2px focus ring around radio indicator</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
          ...
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            ...
            <td style="padding: 0.5rem 0.75rem;">Error message with <code style="${l.monoSm}">role="alert"</code> for immediate announcement</td>
          </tr>
          <tr>
            ...
            <td style="padding: 0.5rem 0.75rem;"><code style="${l.monoSm}">role="radio"</code> + <code style="${l.monoSm}">aria-checked</code> (true/false)</td>
          </tr>
        </tbody>
      </table>
      ...
      <ul style="${l.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        ...
        <li style="margin-bottom: 0.5rem;"><strong>Group context:</strong> When inside <code style="${l.monoSm}">mms-radio-group</code>, announces position (e.g., "1 of 3")</li>
        <li style="margin-bottom: 0.5rem;"><strong>Required:</strong> Announces "required" when <code style="${l.monoSm}">required</code> prop is set</li>
        <li style="margin-bottom: 0.5rem;"><strong>Error:</strong> Immediately announces error message via <code style="${l.monoSm}">role="alert"</code></li>
        <li><strong>Helper text:</strong> Read as part of field description via <code style="${l.monoSm}">aria-describedby</code></li>
      </ul>
  ...
  `},p={name:`Playground`,tags:[`!dev`],args:{label:`Option A`,selected:!1,value:`option-a`,colorScheme:`primary`,size:`md`,state:`default`,readonly:!1,disabled:!1,error:!1,errorText:`Please select an option`,required:!1,heading:``,helperText:``,fieldName:``,theme:`maximus`},decorators:[e=>n`
        <div
          style="
            min-height: 120px;
            display: flex;
  ...
  `)}\n></mms-radio>`},language:`html`}}},render:e=>i(e.theme,e.colorScheme)?n`
      <mms-radio
        label=${e.label}
        ?selected=${e.selected}
        value=${e.value}
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; font-size: 0.875rem;">
        ...
        <tbody>
          ...
          <tr>
            <td style="padding: 0.5rem 0.75rem;"><strong>4.1.2</strong> Name, Role, Value</td>
            <td style="padding: 0.5rem 0.75rem;">Accessible name and state</td>
            <td style="padding: 0.5rem 0.75rem;"><code style="\${t.monoSm}">role="radio"</code> + <code style="\${t.monoSm}">aria-checked</code> (true/false)</td>
          </tr>
        </tbody>
      </table>
...
}`,...p.parameters?.docs?.source}}},m=[`Overview`,`PlaygroundStory`]}));h();export{f as Overview,p as PlaygroundStory,m as __namedExportsOrder,c as default,h as n,s as t};