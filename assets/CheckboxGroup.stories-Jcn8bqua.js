import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,n as r,p as i,s as a,t as o}from"./lit-aQ4dERgF.js";import{f as s,m as c,n as l,o as u,t as d}from"./decorate-CFSc4vnv.js";import{n as f,r as p,t as m}from"./theme-constraints-DyQSN_xs.js";import{t as h}from"./mms-checkbox.component-D7xGVYPo.js";var g,_=e((()=>{o(),u(),h(),l(),g=class extends r{constructor(...e){super(...e),this.label=``,this.helperText=``,this.name=``,this.showTooltip=!1,this.tooltipText=``,this.colorScheme=`primary`,this.size=`md`,this.disabled=!1,this.readonly=!1,this.error=!1,this.errorText=``,this.required=!1}static{this.styles=i`
    /* ═══════════════════════════════════════════════════════════════════════
       HOST
       ═══════════════════════════════════════════════════════════════════════ */
    :host {
  ...
  `}_propagateToCheckboxes(){let e=this.shadowRoot?.querySelector(`slot`);e&&e.assignedElements({flatten:!0}).filter(e=>e.tagName===`MMS-CHECKBOX`).forEach(e=>{e.setAttribute(`color-scheme`,this.colorScheme),e.setAttribute(`size`,this.size),this.disabled?e.setAttribute(`disabled`,``):e.removeAttribute(`disabled`),this.readonly?e.setAttribute(`readonly`,``):e.removeAttribute(`readonly`),this.name&&e.setAttribute(`field-name`,this.name)})}_handleSlotChange(){this._propagateToCheckboxes()}updated(e){super.updated(e),(e.has(`colorScheme`)||e.has(`size`)||e.has(`disabled`)||e.has(`readonly`)||e.has(`name`))&&this._propagateToCheckboxes()}render(){return a`
      ...
      ${this.error&&this.errorText?a`
          ...
          `:n}
    `}},d([s({type:String})],g.prototype,`label`,void 0),d([s({type:String,attribute:`helper-text`})],g.prototype,`helperText`,void 0),d([s({type:String})],g.prototype,`name`,void 0),d([s({type:Boolean,reflect:!0,attribute:`show-tooltip`})],g.prototype,`showTooltip`,void 0),d([s({type:String,attribute:`tooltip-text`})],g.prototype,`tooltipText`,void 0),d([s({type:String,reflect:!0,attribute:`color-scheme`})],g.prototype,`colorScheme`,void 0),d([s({type:String,reflect:!0})],g.prototype,`size`,void 0),d([s({type:Boolean,reflect:!0})],g.prototype,`disabled`,void 0),d([s({type:Boolean,reflect:!0})],g.prototype,`readonly`,void 0),d([s({type:Boolean,reflect:!0})],g.prototype,`error`,void 0),d([s({type:String,attribute:`error-text`})],g.prototype,`errorText`,void 0),d([s({type:Boolean,reflect:!0})],g.prototype,`required`,void 0),g=d([c(`mms-checkbox-group`)],g)})),v=t({Overview:()=>C,PlaygroundStory:()=>w,__namedExportsOrder:()=>T,default:()=>y}),y,b,x,S,C,w,T,E=e((()=>{o(),_(),h(),f(),y={title:`Forms/Checkbox Group`,tags:[`!autodocs`]},b={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},x=`680px`,S=`960px`,C={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${S}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <!-- Header -->
      <h1 style="${b.h1}">Checkbox Group</h1>
      ...
      <p style="${b.bodySm} opacity: 0.85; max-width: ${x}; margin-bottom: 1.5rem;">
        Wrap multiple <code style="${b.monoSm}">&lt;mms-checkbox&gt;</code> elements inside a group 
        with a shared label.
      </p>
      ...
      <p style="${b.bodySm} opacity: 0.85; max-width: ${x}; margin-bottom: 1.5rem;">
        The <code style="${b.monoSm}">color-scheme</code> prop propagates to all child checkboxes.
      </p>
      ...
      <p style="${b.bodySm} opacity: 0.85; max-width: ${x}; margin-bottom: 1.5rem;">
        The <code style="${b.monoSm}">size</code> prop propagates to all child checkboxes.
      </p>
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; font-size: 0.875rem;">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            ...
            <td style="padding: 0.5rem 0.75rem;"><code style="${b.monoSm}">role="group"</code> with <code style="${b.monoSm}">aria-labelledby</code> pointing to group label</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
          ...
          <tr>
            ...
            <td style="padding: 0.5rem 0.75rem;">Each checkbox uses <code style="${b.monoSm}">role="checkbox"</code> + <code style="${b.monoSm}">aria-checked</code></td>
          </tr>
        </tbody>
      </table>
