import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,m as r,n as i,s as a,t as o}from"./lit-CBo78ikN.js";import{d as s,l as c,n as l,r as u,t as d}from"./decorate-Bygya6Tu.js";import{a as f,o as p,r as m,t as h}from"./a11y-outcome-CiARakld.js";var g,_,v=e((()=>{o(),u(),l(),g={fromAttribute:e=>e!==`false`,toAttribute:e=>e?null:`false`},_=class extends i{constructor(...e){super(...e),this.label=``,this.showLabel=!0,this.size=`sm`,this.progress=0,this.valuePlacement=`label-row`,this.showCompleteText=!1,this.colorScheme=`primary`}static{this.styles=r`
    :host {
      display: flex;
  ...
  `}get clampedProgress(){return Math.min(100,Math.max(0,this.progress))}get valueText(){let e=this.clampedProgress;return this.showCompleteText?`${e}% complete`:`${e}%`}render(){let e=this.clampedProgress,t=this.valueText,r=this.valuePlacement===`inline`,i=a`
    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${C}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <p style="${x.body} opacity: 0.85; max-width: ${S}; margin-bottom: 2rem;">
        A determinate progress indicator — represents completion of a user-initiated process whose
        total duration or extent is known (e.g. a multi-step application, a file upload). For an
        indeterminate loading state where progress cannot be measured, see
        <code style="${x.monoSm}">mms-loading-bar</code>.
      </p>
      ...
      <p style="${x.bodySm} opacity: 0.85; max-width: ${S}; margin-bottom: 1.5rem;">
        ...
        (8px, default), <code style="${x.monoSm}">md</code> (12px), or <code style="${x.monoSm}">lg</code> (16px).
      </p>
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; margin-bottom: 2rem;">
        <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px;">
          <p style="${x.h3}">sm (default)</p>
  ...
  `},T={name:`Playground`,tags:[`!dev`],args:{label:`Application progress`,showLabel:!0,progress:65,size:`sm`,valuePlacement:`label-row`,showCompleteText:!1,colorScheme:`primary`,theme:`maximus`,density:`default`},decorators:[e=>a`
      <div
        style="
          display: flex;
  ...
  render: () => html\`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: \${PAGE_MAX}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <p style="\${t.bodySm} opacity: 0.85; max-width: \${PROSE_MAX}; margin-bottom: 1.5rem;">
        ...
        (8px, default), <code style="\${t.monoSm}">md</code> (12px), or <code style="\${t.monoSm}">lg</code> (16px).
      </p>
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; margin-bottom: 2rem;">
        <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px;">
          <p style="\${t.h3}">sm (default)</p>
          <mms-progress-bar label="Progress" size="sm" progress="55"></mms-progress-bar>
        </div>
        <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px;">
          <p style="\${t.h3}">md</p>
  ...
  argTypes: {
    ...
    size: {
      ...
      control: 'select',
      options: ['sm', 'md', 'lg'],
      description: 'Track thickness: sm (8px, default) | md (12px) | lg (16px)',
      table: {
        category: 'Visual'
      }
    },
    ...
    docs: {
      source: {
        transform: (_src: string, ctx: {
          ...
          if (a.size !== 'sm') attrs.push(\`size="\${a.size}"\`);
