    ...
    <div data-theme="maximus" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${o}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <div style="background: rgba(59, 130, 246, 0.08); border-left: 3px solid #3B82F6; padding: 1rem 1.25rem; margin-bottom: 2rem; border-radius: 0 6px 6px 0;">
        <p style="${i.bodySm} margin: 0;">
          <strong>Three structural palettes:</strong> <em>Onyx</em> for high-contrast interactive elements (unbranded buttons), <em>Neutral</em> for backgrounds and text, and <em>Utility</em> for status colors (success, error, caution) and USWDS hyperlinks.
        </p>
      </div>
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; margin-bottom: 2rem;">
        ...
        <div style="background: rgba(128,128,128,0.04); border: 1px solid rgba(128,128,128,0.15); border-radius: 8px; padding: 1.25rem;">
          ...
          <p style="${i.caption} opacity: 0.75; margin-bottom: 1rem;">Fixed colors for status feedback and links. Success, error, caution, USWDS hyperlinks.</p>
          <div style="display: flex; gap: 6px; margin-bottom: 0.75rem;">
            ...
            <div style="width: 24px; height: 20px; border-radius: 2px; background: var(--color-utility-link);"></div>
          </div>
...
&lt;mms-button color-scheme="onyx"&gt;Submit&lt;/mms-button&gt;</pre>
  ...
  `},d={1:{purpose:`Page — body background`,hex:`#fcfcfc`},2:{purpose:`Surface — cards, sidebars, panels`,hex:`#f9f9f9`},3:{purpose:`Element — ghost button, list item default`,hex:`#f0f0f0`},4:{purpose:`Element hovered`,hex:`#e8e8e8`},5:{purpose:`Element pressed — selected item`,hex:`#e0e0e0`},6:{purpose:`Separator — dividers, card borders`,hex:`#b8b8b8`},7:{purpose:`Border — input borders, button outlines`,hex:`#878787`},8:{purpose:`Border hovered — emphasized outlines`,hex:`#737373`},9:{purpose:`Solid (anchor) — filled elements`,hex:`#606060`},10:{purpose:`Solid hovered`,hex:`#484848`},11:{purpose:`Text muted — secondary text, captions`,hex:`#303030`},12:{purpose:`Text — body, headings`,hex:`#1a1a1a`}},f={1:{purpose:`Page — body background`,hex:`#060606`},2:{purpose:`Surface — cards, sidebars, panels`,hex:`#151515`},3:{purpose:`Element — ghost button, list item default`,hex:`#191919`},4:{purpose:`Element hovered`,hex:`#1d1d1d`},5:{purpose:`Element pressed — selected item`,hex:`#262626`},6:{purpose:`Separator — dividers, card borders`,hex:`#444444`},7:{purpose:`Border — input borders, button outlines`,hex:`#636363`},8:{purpose:`Border hovered — emphasized outlines`,hex:`#7d7d7d`},9:{purpose:`Solid (anchor) — filled elements`,hex:`#979797`},10:{purpose:`Solid hovered`,hex:`#b0b0b0`},11:{purpose:`Text muted — secondary text, captions`,hex:`#cacaca`},12:{purpose:`Text — body, headings`,hex:`#e3e3e3`}},p={name:`Neutral`,render:()=>t`
    <div data-theme="default" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${o}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
...
.input::placeholder {
  ...
  `},m=[{category:`Success`,tokens:[{token:`--color-utility-success-muted`,hex:`#c6f3c6`,label:`Surface background`},{token:`--color-utility-success-emphasis`,hex:`#0e580e`,label:`Text, borders, icons`}]},{category:`Error`,tokens:[{token:`--color-utility-error-muted`,hex:`#f3ac99`,label:`Surface background`},{token:`--color-utility-error-emphasis`,hex:`#aa010e`,label:`Text, borders, icons`}]},{category:`Caution`,tokens:[{token:`--color-utility-caution-muted`,hex:`#faf3d1`,label:`Surface background`},{token:`--color-utility-caution-emphasis`,hex:`#936f38`,label:`Text, borders, icons (USWDS warning-darker)`}]},{category:`Informational`,note:`-muted/-stroke are fixed across all themes/modes, same pattern as Success/Error/Caution. -text is a mode-swapping neutral, used only by mms-inline-alert/mms-alert-banner's emphasis-on-raised-surface mechanism.`,tokens:[{token:`--color-utility-informational-muted`,hex:`#f0f0f0`,label:`Surface background (toast, status tag)`,border:!0},{token:`--color-utility-informational-stroke`,hex:`#878787`,label:`Border (toast, status tag)`},{token:`--color-utility-informational-text`,hex:`var(--color-neutral-11)`,label:`Emphasis/fill (inline alert, alert banner)`}]},{category:`On-Fill & Notification`,note:`Special-purpose utility tokens`,tokens:[{token:`--color-utility-on-fill`,hex:`#ffffff`,label:`White text/icons on emphasis fills`,border:!0},{token:`--color-utility-notification`,hex:`#aa010e`,label:`Badge/indicator fill`}]},{category:`Placeholder Text`,note:`Form input placeholder text — NOT part of the neutral scale. Tuned for 4.5:1 contrast on all neutral surfaces including surface-sunken (#f0f0f0).`,tokens:[{token:`--color-text-placeholder (light)`,hex:`#6d6d6d`,label:`Placeholder text on light backgrounds (5.0:1 on #fcfcfc, 4.5:1 on #f0f0f0)`},{token:`--color-text-placeholder (dark)`,hex:`#8c8c8c`,label:`Placeholder text on dark backgrounds (4.5:1 on #262626)`}]},{category:`Link (Light Mode)`,note:`USWDS-aligned hyperlink colors for light backgrounds — structural (not brand-dependent). Meets WCAG AA contrast requirements.`,tokens:[{token:`--color-utility-link`,hex:`#005ea2`,label:`Default hyperlink text (4.54:1 on white)`},{token:`--color-utility-link-hover`,hex:`#0b4778`,label:`Hover state (8.18:1 on white)`},{token:`--color-utility-link-visited`,hex:`#54278f`,label:`Visited link (7.28:1 on white)`}]},{category:`Link (Dark Mode)`,note:`USWDS-aligned hyperlink colors for dark backgrounds — auto-applied via [data-mode="dark"]. Lighter variants for contrast.`,tokens:[{token:`--color-utility-link-dark`,hex:`#58b4ff`,label:`Default hyperlink text (7.5:1 on #060606)`},{token:`--color-utility-link-hover-dark`,hex:`#a9d6ff`,label:`Hover state (11.2:1 on #060606)`},{token:`--color-utility-link-visited-dark`,hex:`#c9b6e4`,label:`Visited link (8.9:1 on #060606)`}]},{category:`Focus Ring`,note:`Accessibility-critical — never themed away. See Foundations > Focus Ring for full documentation.`,tokens:[{token:`--focus-ring-color`,hex:`#386CF7`,label:`Focus indicator outline color`}]}],h=(e,t=!1)=>`background: ${e}; width: 40px; height: 40px; border-radius: 6px; flex-shrink: 0;${t?` border: 1px solid rgba(128,128,128,0.3);`:``}`,g=(e,n,r,a=!1)=>t`
  <tr style="border-bottom: 1px solid rgba(128,128,128,0.12);">
    <td style="padding: 0.5rem 0.75rem;">
      <div style="${h(n,a)}"></div>
    </td>
...
/* Hyperlink — uses semantic tokens that auto-swap for dark mode */
a {
  color: var(--color-link-default);       /* #005ea2 light, #58b4ff dark */
}
a:hover {
  color: var(--color-link-hover);         /* #0b4778 light, #a9d6ff dark */
}
a:visited {
  color: var(--color-link-visited);       /* #54278f light, #c9b6e4 dark */
}

/* Informational toast/tag (fixed across themes/modes, same pattern as success/error/caution) */
.toast-info {
  background: var(--color-utility-informational-muted);
  ...
  name: 'Overview',
  render: () => html\`
    <div data-theme="maximus" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: \${PAGE_MAX}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; margin-bottom: 2rem;">
        ...
        <div style="background: rgba(128,128,128,0.04); border: 1px solid rgba(128,128,128,0.15); border-radius: 8px; padding: 1.25rem;">
          ...
          <p style="\${t.caption} opacity: 0.75; margin-bottom: 1rem;">Fixed colors for status feedback and links. Success, error, caution, USWDS hyperlinks.</p>
          <div style="display: flex; gap: 6px; margin-bottom: 0.75rem;">
            <div style="width: 24px; height: 20px; border-radius: 2px; background: var(--color-utility-success-emphasis);"></div>
            <div style="width: 24px; height: 20px; border-radius: 2px; background: var(--color-utility-error-emphasis);"></div>
            <div style="width: 24px; height: 20px; border-radius: 2px; background: var(--color-utility-caution-emphasis);"></div>
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 2rem;">
        ...
        <tbody>
          ...
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.12);">
            ...
            <td style="padding: 0.75rem; \${t.caption} opacity: 0.75;">Success/error/caution states, validation, notifications, hyperlinks (USWDS blue)</td>
...
&lt;mms-button color-scheme="onyx"&gt;Submit&lt;/mms-button&gt;</pre>
  ...
  name: 'Neutral',
  render: () => html\`
    <div data-theme="default" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: \${PAGE_MAX}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
