...
&lt;mms-button variant="ghost" label="Learn more"&gt;&lt;/mms-button&gt;</code></pre>
  ...
  `},y={name:`Playground`,tags:[`!dev`],args:{variant:`primary`,size:`md`,roundness:`subtle`,state:`default`,disabled:!1,label:`Button`,leftIcon:``,rightIcon:``,iconOnly:!1,ariaLabel:``,colorScheme:`primary`,theme:`maximus`,density:`default`},decorators:[e=>n`
        <div
          style="
            min-height: 80px;
            display: flex;
