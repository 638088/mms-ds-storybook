        ...
        <table style="width: 100%; border-collapse: collapse; ${o.caption}">
          ...
          <tbody>
            <tr style="border-bottom: 1px solid rgba(128,128,128,0.12);">
              ...
              <td style="padding: 0.5rem 0.75rem; ${o.caption}">Avenir Next</td>
...
td { font-family: var(--font-family-tabular); }</pre>
  ...
  `},h={name:`Designing in Figma`,render:()=>n`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${c}; margin: 0 auto; padding: 2rem; color: inherit;">
        ...
        <table style="width: 100%; border-collapse: collapse; \${t.caption}">
          ...
          <tbody>
            <tr style="border-bottom: 1px solid rgba(128,128,128,0.12);">
              ...
              <td style="padding: 0.5rem 0.75rem; \${t.caption}">Avenir Next</td>
...
td { font-family: var(--font-family-tabular); }</pre>
  ...
  argTypes: {
    brand: {
      control: 'select',
      options: ['maximus', 'va-gov', 'uss-oh-dvs', 'system fonts'],
