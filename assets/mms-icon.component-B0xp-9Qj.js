...
import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{n as t,t as n}from"./preload-helper-si3HNj2m.js";import{c as r,i,m as a,n as o,o as s,s as c,t as l}from"./lit-CBo78ikN.js";import{a as u,f as d,m as f,n as p,o as m,r as h,t as g,u as _}from"./decorate-BdwtT8fT.js";var v,y,b,x=e((()=>{v={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},y=e=>(...t)=>({_$litDirective$:e,values:t}),b=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}})),S,C=e((()=>{r(),x(),S=class extends b{constructor(e){if(super(e),this.it=i,e.type!==v.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===i||e==null)return this._t=void 0,this.it=e;if(e===s)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}},S.directiveName=`unsafeHTML`,S.resultType=1,y(S)})),w,T,E=e((()=>{x(),C(),w=class extends S{},w.directiveName=`unsafeSVG`,w.resultType=2,T=y(w)})),D=e((()=>{E()}));function O(){return A||=n(()=>import(`./icon-svgs-Bccdi0p1.js`).then(e=>{k=e.default||e}),__vite__mapDeps([0,1]),import.meta.url).catch(e=>{console.warn(`mms-icon: failed to load SVG registry`,e)}),A}var k,A,j,M=e((()=>{l(),m(),D(),u(),p(),t(),k={},A=null,j=class extends o{constructor(...e){super(...e),this.name=`question`,this.size=`lg`,this.weight=`regular`,this.label=``,this.badge=``,this._svgsLoaded=!1}static{this.styles=[h,a`
      :host {
        display: inline-flex;
        align-items: center;
