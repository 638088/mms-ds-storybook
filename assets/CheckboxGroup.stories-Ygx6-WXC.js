import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,n as r,p as i,s as a,t as o}from"./lit-aQ4dERgF.js";import{f as s,m as c,n as l,o as u,t as d}from"./decorate-CFSc4vnv.js";import{n as f,r as p,t as m}from"./theme-constraints-D-yar-OC.js";import{a as h,o as g,r as _,t as v}from"./a11y-outcome-DlWsiEtn.js";import{t as y}from"./mms-checkbox.component-B6jhWkos.js";var b,x=e((()=>{o(),u(),y(),l(),b=class extends r{constructor(...e){super(...e),this.label=``,this.helperText=``,this.name=``,this.showTooltip=!1,this.tooltipText=``,this.colorScheme=`primary`,this.size=`md`,this.disabled=!1,this.readonly=!1,this.error=!1,this.errorText=``,this.required=!1}static{this.styles=i`
    /* ═══════════════════════════════════════════════════════════════════════
       HOST
       ═══════════════════════════════════════════════════════════════════════ */
    :host {
  ...
  `}_propagateToCheckboxes(){let e=this.shadowRoot?.querySelector(`slot`);e&&e.assignedElements({flatten:!0}).filter(e=>e.tagName===`MMS-CHECKBOX`).forEach(e=>{e.setAttribute(`color-scheme`,this.colorScheme),e.setAttribute(`size`,this.size),this.disabled?e.setAttribute(`disabled`,``):e.removeAttribute(`disabled`),this.readonly?e.setAttribute(`readonly`,``):e.removeAttribute(`readonly`),this.name&&e.setAttribute(`field-name`,this.name)})}_handleSlotChange(){this._propagateToCheckboxes()}updated(e){super.updated(e),(e.has(`colorScheme`)||e.has(`size`)||e.has(`disabled`)||e.has(`readonly`)||e.has(`name`))&&this._propagateToCheckboxes()}render(){return a`
      ...
      ${this.error&&this.errorText?a`
          ...
          `:n}
    `}},d([s({type:String})],b.prototype,`label`,void 0),d([s({type:String,attribute:`helper-text`})],b.prototype,`helperText`,void 0),d([s({type:String})],b.prototype,`name`,void 0),d([s({type:Boolean,reflect:!0,attribute:`show-tooltip`})],b.prototype,`showTooltip`,void 0),d([s({type:String,attribute:`tooltip-text`})],b.prototype,`tooltipText`,void 0),d([s({type:String,reflect:!0,attribute:`color-scheme`})],b.prototype,`colorScheme`,void 0),d([s({type:String,reflect:!0})],b.prototype,`size`,void 0),d([s({type:Boolean,reflect:!0})],b.prototype,`disabled`,void 0),d([s({type:Boolean,reflect:!0})],b.prototype,`readonly`,void 0),d([s({type:Boolean,reflect:!0})],b.prototype,`error`,void 0),d([s({type:String,attribute:`error-text`})],b.prototype,`errorText`,void 0),d([s({type:Boolean,reflect:!0})],b.prototype,`required`,void 0),b=d([c(`mms-checkbox-group`)],b)})),S=t({Overview:()=>D,PlaygroundStory:()=>O,__namedExportsOrder:()=>k,default:()=>C}),C,w,T,E,D,O,k,A=e((()=>{o(),x(),y(),f(),h(),v(),C={title:`Forms/Checkbox Group`,tags:[`!autodocs`]},w={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},T=`680px`,E=`960px`,D={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${E}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <!-- Header -->
      <h1 style="${w.h1}">Checkbox Group</h1>
      ...
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        Wrap multiple <code style="${w.monoSm}">&lt;mms-checkbox&gt;</code> elements inside a group 
        with a shared label.
      </p>
      ...
      <!-- Required Group -->
      <h2 style="${w.h2}">Required group</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
      ...
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        The <code style="${w.monoSm}">error</code> prop displays validation feedback for the entire group.
      ...
      <!-- Color Schemes -->
      <h2 style="${w.h2}">Color schemes</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        The <code style="${w.monoSm}">color-scheme</code> prop propagates to all child checkboxes.
      </p>
      ...
      <!-- Sizes -->
      <h2 style="${w.h2}">Sizes</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        The <code style="${w.monoSm}">size</code> prop propagates to all child checkboxes.
      </p>
      ...
      <!-- Disabled & Readonly -->
      <h2 style="${w.h2}">Disabled &amp; read-only</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
      ...
      <ul style="${w.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        ...
        <li style="margin-bottom: 0.5rem;"><strong>Required:</strong> Announces "required" when <code style="${w.monoSm}">required</code> prop is set on group</li>
        <li style="margin-bottom: 0.5rem;"><strong>Error:</strong> Immediately announces group error message via <code style="${w.monoSm}">role="alert"</code></li>
        <li><strong>Helper text:</strong> Read as part of group description via <code style="${w.monoSm}">aria-describedby</code></li>
      </ul>
  ...
  `)}\n>\n${i.join(`
`)}\n</mms-checkbox-group>`},language:`html`}}},render:e=>{let t=p(e.theme,e.colorScheme),r=m(e.theme,e.colorScheme);if(!t){let t=r===2?`Tier 2 (Text + Surface)`:`Tier 3 (Decorative)`,n=r===2?`Lacks step 10 (hover state). Use for branded text or badges, not checkboxes.`:`Lacks text contrast and hover states. Decorative backgrounds only.`;return a`
        <div style="
          padding: 1.5rem 2rem;
          background: #fef2f2;
