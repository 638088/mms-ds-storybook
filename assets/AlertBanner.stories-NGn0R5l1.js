import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,n as r,p as i,s as a,t as o}from"./lit-aQ4dERgF.js";import{a as s,f as c,i as l,m as u,n as d,o as f,t as p}from"./decorate-CFSc4vnv.js";import{t as m}from"./mms-icon.component-Cz1Jc6Sy.js";import{t as h}from"./iframe-HnRd4-qG.js";import{a as g,o as _,r as v,t as y}from"./a11y-outcome-BIVC7m09.js";var b,x=e((()=>{o(),f(),s(),m(),h(),d(),b=class extends r{constructor(...e){super(...e),this.alertType=`informational`,this.actionPosition=`below`,this.action=!0,this.summary=``,this.message=`Additional information goes here.`,this.actionText=`Text link`,this.actionHref=`#`,this.autoDismiss=!1,this.autoDismissDuration=8e3,this._isHovered=!1,this._isFocused=!1,this._dismissTimer=null,this._handleDismiss=e=>{this._stopDismissTimer(),this.dispatchEvent(new CustomEvent(`dismiss`,{bubbles:!0,composed:!0,detail:{reason:e}}))},this._handleCloseClick=()=>{this._handleDismiss(`user`)},this._handleActionClick=()=>{this.dispatchEvent(new CustomEvent(`action-click`,{bubbles:!0,composed:!0,detail:{href:this.actionHref}}))},this._handleMouseEnter=()=>{this._isHovered=!0,this._stopDismissTimer()},this._handleMouseLeave=()=>{this._isHovered=!1,this._startDismissTimer()},this._handleFocusIn=()=>{this._isFocused=!0,this._stopDismissTimer()},this._handleFocusOut=e=>{let t=e.relatedTarget;t&&(this.shadowRoot?.contains(t)||this.contains(t))||(this._isFocused=!1,this._startDismissTimer())},this._handleVisibilityChange=()=>{document.hidden?this._stopDismissTimer():this._startDismissTimer()}}static{this.styles=[l,i`
    ...
    `]}_getIconName(){switch(this.alertType){case`success`:return`check-circle`;case`error`:return`warning-circle`;case`caution`:return`warning`;default:return`info`}}_startDismissTimer(){this._stopDismissTimer(),!(!this.autoDismiss||this._isHovered||this._isFocused||document.hidden)&&(this._dismissTimer=setTimeout(()=>{this._handleDismiss(`timeout`)},this.autoDismissDuration))}_stopDismissTimer(){this._dismissTimer&&=(clearTimeout(this._dismissTimer),null)}_renderTextLink(e){return a`
      ...
      ></mms-link>
    `}connectedCallback(){super.connectedCallback(),this.hasAttribute(`role`)||this.setAttribute(`role`,`status`),document.addEventListener(`visibilitychange`,this._handleVisibilityChange),this._startDismissTimer()}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`visibilitychange`,this._handleVisibilityChange),this._stopDismissTimer()}updated(e){super.updated(e),(e.has(`autoDismiss`)||e.has(`autoDismissDuration`))&&this._startDismissTimer()}render(){let e=this.actionPosition===`right`;return a`
      <div
        class="container"
    ...
    `}},p([c({type:String,reflect:!0,attribute:`alert-type`})],b.prototype,`alertType`,void 0),p([c({type:String,reflect:!0,attribute:`action-position`})],b.prototype,`actionPosition`,void 0),p([c({type:Boolean,reflect:!0})],b.prototype,`action`,void 0),p([c({type:String})],b.prototype,`summary`,void 0),p([c({type:String})],b.prototype,`message`,void 0),p([c({type:String,attribute:`action-text`})],b.prototype,`actionText`,void 0),p([c({type:String,attribute:`action-href`})],b.prototype,`actionHref`,void 0),p([c({type:Boolean,reflect:!0,attribute:`auto-dismiss`})],b.prototype,`autoDismiss`,void 0),p([c({type:Number,attribute:`auto-dismiss-duration`})],b.prototype,`autoDismissDuration`,void 0),b=p([u(`mms-alert-banner`)],b)})),S=t({LayoutBehavior:()=>k,Overview:()=>D,PlaygroundStory:()=>A,__namedExportsOrder:()=>j,default:()=>C}),C,w,T,E,D,O,k,A,j,M=e((()=>{o(),x(),g(),y(),C={title:`Feedback/Alert Banner`,tags:[`!autodocs`]},w={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},T=`680px`,E=`960px`,D={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${E}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        Defaults to the <code style="${w.monoSm}">informational</code> type with a below-message text-link action.
      </p>
      ...
      <!-- Action Position -->
      <h2 style="${w.h2}">Action position</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        <code style="${w.monoSm}">action-position="below"</code> (default) places the text link on its
        own line beneath the message. <code style="${w.monoSm}">action-position="right"</code> flows
      ...
      <!-- Without action -->
      <h2 style="${w.h2}">Without an action</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        Setting <code style="${w.monoSm}">action</code> to <code style="${w.monoSm}">false</code> hides the text link entirely — for a message that needs no follow-up.
      </p>
      ...
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        The close button fires a <code style="${w.monoSm}">dismiss</code> event — the host page owns
        removal from the DOM (e.g. <code style="${w.monoSm}">@dismiss=\${() => el.remove()}</code>);
        the component does not remove itself. Manual dismiss is the default; setting
        <code style="${w.monoSm}">auto-dismiss</code> opts the banner into also firing
        <code style="${w.monoSm}">dismiss</code> on a timer (<code style="${w.monoSm}">detail.reason</code>
        is <code style="${w.monoSm}">'user'</code> or <code style="${w.monoSm}">'timeout'</code> accordingly) —
      ...
      <div style="background: rgba(34, 197, 94, 0.08); border-left: 3px solid #22C55E; padding: 1rem 1.25rem; margin-bottom: 1.5rem; border-radius: 0 6px 6px 0;">
        <p style="${w.bodySm} margin: 0;">
          <strong>Why <code style="${w.monoSm}">role="status"</code>, not <code style="${w.monoSm}">role="alert"</code>?</strong>
          Alert Banner surfaces general status information — including <code style="${w.monoSm}">error</code> type —
          that is not critical or blocking. <code style="${w.monoSm}">role="status"</code>'s implicit
          <code style="${w.monoSm}">aria-live="polite"</code> announces the banner without interrupting the
      ...
      <div style="background: rgba(59, 130, 246, 0.08); border-left: 3px solid #3B82F6; padding: 1rem 1.25rem; margin-bottom: 1.5rem; border-radius: 0 6px 6px 0;">
        <p style="${w.bodySm} margin: 0 0 0.5rem;">
          <strong>Why doesn't 1.4.11 Non-Text Contrast apply to <code style="${w.monoSm}">informational</code>'s border?</strong>
        </p>
        <p style="${w.bodySm} margin: 0 0 0.5rem;">
          1.4.11 only applies to graphical objects <em>required to identify or understand content</em> — it is
          not a blanket 3:1 rule for every border. The <code style="${w.monoSm}">informational</code> alert
          type is already conveyed by the status icon (with its own <code style="${w.monoSm}">aria-label</code>)
        ...
        <p style="${w.bodySm} margin: 0 0 0.5rem;">
          For reference, <code style="${w.monoSm}">informational</code> is the one alert type without a
          dedicated structural utility hue — it borrows <code style="${w.monoSm}">--color-border-default</code>
          (<code style="${w.monoSm}">--color-neutral-6</code>, <code style="${w.monoSm}">#b8b8b8</code>) against
          the banner's <code style="${w.monoSm}">--color-surface-raised</code>
          (<code style="${w.monoSm}">#fcfcfc</code>) background — a computed ratio of ~1.77:1. That number is
          background context for why the exemption matters here, not a contrast figure this component needs to
          clear.
        </p>
        <p style="${w.bodySm} margin: 0 0 0.5rem;">
          <code style="${w.monoSm}">error</code>, <code style="${w.monoSm}">success</code>, and
          <code style="${w.monoSm}">caution</code> happen to clear 3:1 regardless — each reuses the same
          ...
          the other three by meeting the ratio, <code style="${w.monoSm}">informational</code> by the criterion
          not applying.
        </p>
        <p style="${w.bodySm} margin: 0; opacity: 0.85;">
          <strong>Caveat:</strong> this exemption holds only as long as the status icon and its label continue
          to accompany the <code style="${w.monoSm}">informational</code> variant. If a future revision ever
      ...
      <ul style="${w.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        <li style="margin-bottom: 0.5rem;"><strong>On render:</strong> Announces politely (does not interrupt) via <code style="${w.monoSm}">role="status"</code> — summary, message, and action link text are read as content</li>
        <li style="margin-bottom: 0.5rem;"><strong>Status icon:</strong> Announced via its <code style="${w.monoSm}">aria-label</code> (e.g. "error alert"), not left silent as decorative</li>
  ...
  `},O={frame:`border: 2px dashed rgba(128,128,128,0.35); border-radius: 8px; padding: 2rem 1.5rem 1rem; position: relative; margin-bottom: 0.75rem;`,frameLabel:`position: absolute; top: -0.7rem; left: 1rem; background: var(--color-surface-default, #fff); padding: 0 0.5rem; font-size: 0.75rem; font-weight: 600; opacity: 0.6; text-transform: uppercase; letter-spacing: 0.05em;`,content:`border: 1px solid rgba(128,128,128,0.3); border-radius: 6px; padding: 1rem; background: rgba(128,128,128,0.03);`,header:`height: 2.5rem; border-radius: 4px; background: rgba(128,128,128,0.15); display: flex; align-items: center; padding: 0 0.75rem; font-size: 0.75rem; font-weight: 600; opacity: 0.6;`,gap:`display: flex; align-items: center; justify-content: center; gap: 0.375rem; padding: 0.375rem 0; font-size: 0.75rem; opacity: 0.55; font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace;`,bannerEmphasis:`border-radius: 6px; border: 1px solid #3B82F6; background: rgba(59, 130, 246, 0.08); padding: 0.75rem 1rem; font-size: 0.8125rem;`,bannerMuted:`border-radius: 6px; border: 1px dashed rgba(128,128,128,0.3); background: rgba(128,128,128,0.04); padding: 0.75rem 1rem; font-size: 0.8125rem; opacity: 0.6;`,widthRow:`margin: 1rem 2.5rem 0; height: 1.25rem; border-top: 1px solid rgba(128,128,128,0.3); border-left: 1px solid rgba(128,128,128,0.3); border-right: 1px solid rgba(128,128,128,0.3); border-radius: 4px 4px 0 0; display: flex; align-items: flex-end; justify-content: center;`,widthLabel:`font-size: 0.75rem; opacity: 0.55; font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; transform: translateY(0.65rem); background: var(--color-surface-default, #fff); padding: 0 0.375rem;`,caption:`font-size: 0.8125rem; opacity: 0.65; text-align: center; margin: 0.5rem 0 0;`,callout:e=>`background: ${e}0d; border-left: 3px solid ${e}; padding: 1rem 1.25rem; margin-bottom: 1.5rem; border-radius: 0 6px 6px 0;`},k={name:`Layout & Behavior`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${E}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <p style="${w.body} opacity: 0.85; max-width: ${T}; margin-bottom: 2rem;">
        ...
        <code style="${w.monoSm}">width: 100%</code> resolves to the content area's width — the viewport minus
      ...
      <!-- Placement -->
      <h2 style="${w.h2}">Placement</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1rem;">
        ...
        <strong>consumer-implemented layout responsibility</strong> — <code style="${w.monoSm}">:host</code> is
        <code style="${w.monoSm}">position: relative</code> with no sticky/z-index baked in, because the correct
      ...
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1rem;">
        ...
        Below the Xs breakpoint, prefer <code style="${w.monoSm}">action-position="below"</code> as a rule of
        thumb — inline (<code style="${w.monoSm}">"right"</code>) actions are more likely to wrap awkwardly at
      ...
      <div style="display: flex; gap: 1.5rem; margin-bottom: 1.5rem; flex-wrap: wrap;">
        <div style="flex: 1; min-width: 240px;">
          <p style="${w.bodySm} margin: 0 0 0.5rem; opacity: 0.6; font-weight: 600;">✅ Do</p>
          <p style="${w.bodySm} background: rgba(34,197,94,0.06); border: 1px solid rgba(34,197,94,0.3); border-radius: 6px; padding: 0.75rem; margin: 0; opacity: 0.85;">
            Position the banner (or a wrapping container) as <code style="${w.monoSm}">sticky</code> with
            <code style="${w.monoSm}">top</code> set to the host page's actual header height. Stack multiple
            banners with newest on top and the gap rule above.
          </p>
        </div>
        <div style="flex: 1; min-width: 240px;">
          <p style="${w.bodySm} margin: 0 0 0.5rem; opacity: 0.6; font-weight: 600;">❌ Don't</p>
          <p style="${w.bodySm} background: rgba(239,68,68,0.06); border: 1px solid rgba(239,68,68,0.3); border-radius: 6px; padding: 0.75rem; margin: 0; opacity: 0.85;">
            Don't append banners directly to <code style="${w.monoSm}">&lt;body&gt;</code> with no offset — they'll
      ...
      <div style="${O.frame}">
        <span style="${O.frameLabel}">Viewport</span>
        <div style="${O.content}">
          <div style="${O.header}">Header</div>
          <div style="${O.gap}">↕ 4px (Xs) · 8px (Sm–Xl)</div>
          <div style="${O.bannerEmphasis}"><strong>Banner #1</strong> — newest, nearest the header</div>
          <div style="${O.gap}">↕ 4px (Xs) · 8px (Sm–Xl)</div>
          <div style="${O.bannerMuted}">Banner #2 — older, pushed down</div>
        </div>
        <div style="${O.widthRow}"><span style="${O.widthLabel}">content-area width = viewport − layout offsets</span></div>
      </div>
      <p style="${O.caption}">
      ...
      <!-- Responsiveness -->
      <h2 style="${w.h2}">Responsiveness</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1rem;">
        ...
        this correctly: <code style="${w.monoSm}">:host { width: 100%; }</code> resolves to whatever its parent's
        width is, so the consumer's only job is placement — as a direct child of the content-area region,
        alongside <code style="${w.monoSm}">&lt;main&gt;</code>, not nested inside a card, panel, or sidebar, and
        not appended to <code style="${w.monoSm}">&lt;body&gt;</code> above the content area.
      </p>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1rem;">
        This isn't automatic — <code style="${w.monoSm}">width: 100%</code> only ever resolves relative to the
        ...
        offsets correctly. If the banner is placed directly under <code style="${w.monoSm}">&lt;body&gt;</code>
      ...
      <div style="display: flex; gap: 1.5rem; margin-bottom: 1.5rem; flex-wrap: wrap;">
        <div style="flex: 1; min-width: 240px;">
          <p style="${w.bodySm} margin: 0 0 0.5rem; opacity: 0.6; font-weight: 600;">✅ Do</p>
          <pre style="${w.monoSm} background: rgba(34,197,94,0.06); border: 1px solid rgba(34,197,94,0.3); border-radius: 6px; padding: 0.75rem; margin: 0; overflow-x: auto;"><code>&lt;div class="content-area"&gt;
...
&lt;/div&gt;</code></pre>
        ...
        <div style="flex: 1; min-width: 240px;">
          <p style="${w.bodySm} margin: 0 0 0.5rem; opacity: 0.6; font-weight: 600;">❌ Don't</p>
          <pre style="${w.monoSm} background: rgba(239,68,68,0.06); border: 1px solid rgba(239,68,68,0.3); border-radius: 6px; padding: 0.75rem; margin: 0; overflow-x: auto;"><code>&lt;body&gt;
  &lt;mms-alert-banner&gt;&lt;/mms-alert-banner&gt;
...
&lt;/body&gt;</code></pre>
      ...
      <h2 style="${w.h2}">UX Behavior — Dismissal</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1rem;">
        Manual dismiss (the close button) is the default and always available. Setting
        <code style="${w.monoSm}">auto-dismiss</code> opts a banner into <em>also</em> dismissing on a timer —
        <code style="${w.monoSm}">auto-dismiss-duration</code> controls the delay (default
        ...
        Both dismissal paths fire the same <code style="${w.monoSm}">dismiss</code> event, distinguished by
        <code style="${w.monoSm}">event.detail.reason</code> (<code style="${w.monoSm}">'user'</code> or
        <code style="${w.monoSm}">'timeout'</code>) — the component never removes itself from the DOM either
        way; the host page owns that.
      </p>

      <div style="${O.callout(`#F59E0B`)}">
        <p style="${w.bodySm} margin: 0;">
          <strong>Caution:</strong> avoid pairing <code style="${w.monoSm}">auto-dismiss</code> with
          <code style="${w.monoSm}">action</code> unless <code style="${w.monoSm}">auto-dismiss-duration</code>
...
}`,...A.parameters?.docs?.source}}},j=[`Overview`,`LayoutBehavior`,`PlaygroundStory`]}));M();export{k as LayoutBehavior,D as Overview,A as PlaygroundStory,j as __namedExportsOrder,C as default,M as n,S as t};