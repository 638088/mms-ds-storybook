import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{i as t,n,p as r,s as i,t as a}from"./lit-aQ4dERgF.js";import{a as o,d as s,i as c,l,n as u,r as d,t as f}from"./decorate-ClfqJe3w.js";import{r as p,t as m}from"./if-defined-C8GHsg_z.js";var h,g=e((()=>{a(),o(),m(),c(),u(),h=class extends n{constructor(...e){super(...e),this.label=``,this.checked=!1,this.indeterminate=!1,this.colorScheme=`primary`,this.size=`md`,this.state=`default`,this.readonly=!1,this.disabled=!1,this.error=!1,this.errorText=``,this.required=!1,this.heading=``,this.helperText=``,this.fieldName=``,this.checkedValue=`on`}static{this.styles=[d,r`
      /* ═══════════════════════════════════════════════════════════════════════
      ...
      <label class="checkbox-row" @click=${this._handleClick}>
        <span class="indicator-wrapper">
          <input
            ...
            name=${p(this.fieldName||void 0)}
            value=${this.checkedValue}
            aria-describedby=${p(this._ariaDescribedBy)}
    ...
    `}},f([l({type:String})],h.prototype,`label`,void 0),f([l({type:Boolean,reflect:!0})],h.prototype,`checked`,void 0),f([l({type:Boolean,reflect:!0})],h.prototype,`indeterminate`,void 0),f([l({type:String,reflect:!0,attribute:`color-scheme`})],h.prototype,`colorScheme`,void 0),f([l({type:String,reflect:!0})],h.prototype,`size`,void 0),f([l({type:String,reflect:!0})],h.prototype,`state`,void 0),f([l({type:Boolean,reflect:!0})],h.prototype,`readonly`,void 0),f([l({type:Boolean,reflect:!0})],h.prototype,`disabled`,void 0),f([l({type:Boolean,reflect:!0})],h.prototype,`error`,void 0),f([l({type:String,attribute:`error-text`})],h.prototype,`errorText`,void 0),f([l({type:Boolean,reflect:!0})],h.prototype,`required`,void 0),f([l({type:String})],h.prototype,`heading`,void 0),f([l({type:String,attribute:`helper-text`})],h.prototype,`helperText`,void 0),f([l({type:String,attribute:`field-name`})],h.prototype,`fieldName`,void 0),f([l({type:String,attribute:`checked-value`})],h.prototype,`checkedValue`,void 0),h=f([s(`mms-checkbox`)],h),customElements.get(`mms-checkbox`)||customElements.define(`mms-checkbox`,h)}));export{g as t};