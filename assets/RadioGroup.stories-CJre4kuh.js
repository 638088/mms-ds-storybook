import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,n as r,p as i,s as a,t as o}from"./lit-aQ4dERgF.js";import{a as s,d as c,l,n as u,s as d,t as f}from"./decorate-ClfqJe3w.js";import{n as p,r as m,t as h}from"./theme-constraints-DyQSN_xs.js";import{t as g}from"./mms-radio.component-C6AUyieO.js";var _,v=e((()=>{o(),s(),g(),u(),_=class extends r{constructor(...e){super(...e),this.label=``,this.helperText=``,this.name=``,this.value=``,this.showTooltip=!1,this.tooltipText=``,this.colorScheme=`primary`,this.size=`md`,this.orientation=`vertical`,this.disabled=!1,this.readonly=!1,this.error=!1,this.errorText=``,this.required=!1,this._radios=[],this._handleRadioChange=e=>{let t=e.target;if(t.tagName!==`MMS-RADIO`)return;let n=t.getAttribute(`value`)||``;n!==this.value&&(this.value=n,this._propagateToRadios(),this.dispatchEvent(new CustomEvent(`change`,{detail:{value:this.value},bubbles:!0,composed:!0})))},this._handleKeyDown=e=>{if(this.disabled||this.readonly)return;let t=this._radios.filter(e=>!e.hasAttribute(`disabled`));if(t.length===0)return;let n=this._getSelectedIndex(),r=n;switch(e.key){case`ArrowDown`:case`ArrowRight`:e.preventDefault(),r=n<0?0:(n+1)%t.length;break;case`ArrowUp`:case`ArrowLeft`:e.preventDefault(),r=n<0?t.length-1:(n-1+t.length)%t.length;break;case` `:case`Enter`:n<0&&(e.preventDefault(),r=0);break;default:return}if(r!==n&&t[r]){let e=t[r].getAttribute(`value`)||``;this.value=e,this._propagateToRadios(),t[r].focus(),this.dispatchEvent(new CustomEvent(`change`,{detail:{value:this.value},bubbles:!0,composed:!0}))}}}static{this.styles=i`
  ...
  `}connectedCallback(){super.connectedCallback(),this.addEventListener(`keydown`,this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`keydown`,this._handleKeyDown)}updated(e){super.updated(e),(e.has(`colorScheme`)||e.has(`size`)||e.has(`disabled`)||e.has(`readonly`)||e.has(`name`)||e.has(`value`))&&this._propagateToRadios()}_getRadios(){let e=this.shadowRoot?.querySelector(`slot`);return e?e.assignedElements({flatten:!0}).filter(e=>e.tagName===`MMS-RADIO`):[]}_propagateToRadios(){let e=this._getRadios();this._radios=e,e.forEach((e,t)=>{e.setAttribute(`color-scheme`,this.colorScheme),e.setAttribute(`size`,this.size),this.disabled?e.setAttribute(`disabled`,``):e.removeAttribute(`disabled`),this.readonly?e.setAttribute(`readonly`,``):e.removeAttribute(`readonly`),this.name&&e.setAttribute(`field-name`,this.name);let n=e.getAttribute(`value`)||``;this.value&&n===this.value?e.setAttribute(`selected`,``):e.removeAttribute(`selected`);let r=this._getSelectedIndex();t===(r>=0?r:0)&&!this.disabled?e.removeAttribute(`tabindex`):e.setAttribute(`tabindex`,`-1`)})}_getSelectedIndex(){return this._radios.findIndex(e=>e.getAttribute(`value`)===this.value)}_handleSlotChange(){this._propagateToRadios()}render(){return a`
      ...
      ${this.error&&this.errorText?a`
          ...
          `:n}
    `}},f([l({type:String})],_.prototype,`label`,void 0),f([l({type:String,attribute:`helper-text`})],_.prototype,`helperText`,void 0),f([l({type:String})],_.prototype,`name`,void 0),f([l({type:String,reflect:!0})],_.prototype,`value`,void 0),f([l({type:Boolean,reflect:!0,attribute:`show-tooltip`})],_.prototype,`showTooltip`,void 0),f([l({type:String,attribute:`tooltip-text`})],_.prototype,`tooltipText`,void 0),f([l({type:String,reflect:!0,attribute:`color-scheme`})],_.prototype,`colorScheme`,void 0),f([l({type:String,reflect:!0})],_.prototype,`size`,void 0),f([l({type:String,reflect:!0})],_.prototype,`orientation`,void 0),f([l({type:Boolean,reflect:!0})],_.prototype,`disabled`,void 0),f([l({type:Boolean,reflect:!0})],_.prototype,`readonly`,void 0),f([l({type:Boolean,reflect:!0})],_.prototype,`error`,void 0),f([l({type:String,attribute:`error-text`})],_.prototype,`errorText`,void 0),f([l({type:Boolean,reflect:!0})],_.prototype,`required`,void 0),f([d()],_.prototype,`_radios`,void 0),_=f([c(`mms-radio-group`)],_)})),y=t({Overview:()=>w,PlaygroundStory:()=>T,__namedExportsOrder:()=>E,default:()=>b}),b,x,S,C,w,T,E,D=e((()=>{o(),v(),g(),p(),b={title:`Forms/Radio Group`,tags:[`!autodocs`]},x={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},S=`680px`,C=`960px`,w={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${C}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <p style="${x.bodySm} opacity: 0.85; max-width: ${S}; margin-bottom: 1.5rem;">
        Wrap multiple <code style="${x.monoSm}">&lt;mms-radio&gt;</code> elements inside a group 
      ...
      <!-- With Helper Text -->
      <h2 style="${x.h2}">With helper text</h2>
      <p style="${x.bodySm} opacity: 0.85; max-width: ${S}; margin-bottom: 1.5rem;">
      ...
      <h2 style="${x.h2}">Horizontal orientation</h2>
      <p style="${x.bodySm} opacity: 0.85; max-width: ${S}; margin-bottom: 1.5rem;">
        Use <code style="${x.monoSm}">orientation="horizontal"</code> for inline layouts.
      </p>
      ...
      <!-- Required Group -->
      <h2 style="${x.h2}">Required group</h2>
      <p style="${x.bodySm} opacity: 0.85; max-width: ${S}; margin-bottom: 1.5rem;">
        The <code style="${x.monoSm}">required</code> prop adds an asterisk indicator to the label.
      </p>
      ...
      <!-- Error State -->
      <h2 style="${x.h2}">Error state</h2>
      <p style="${x.bodySm} opacity: 0.85; max-width: ${S}; margin-bottom: 1.5rem;">
        The <code style="${x.monoSm}">error</code> prop displays validation feedback for the entire group.
      ...
      <!-- Color Schemes -->
      <h2 style="${x.h2}">Color schemes</h2>
      <p style="${x.bodySm} opacity: 0.85; max-width: ${S}; margin-bottom: 1.5rem;">
        The <code style="${x.monoSm}">color-scheme</code> prop propagates to all child radios.
      </p>
      ...
      <p style="${x.bodySm} opacity: 0.85; max-width: ${S}; margin-bottom: 1.5rem;">
        The <code style="${x.monoSm}">size</code> prop propagates to all child radios.
      </p>
      ...
      <!-- Disabled & Readonly -->
      <h2 style="${x.h2}">Disabled &amp; read-only</h2>
      <p style="${x.bodySm} opacity: 0.85; max-width: ${S}; margin-bottom: 1.5rem;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; font-size: 0.875rem;">
        ...
        <tbody>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            ...
            <td style="padding: 0.5rem 0.75rem;"><code style="${x.monoSm}">role="radiogroup"</code> with <code style="${x.monoSm}">aria-labelledby</code> pointing to group label</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
          ...
          <tr style="border-bottom: 1px solid rgba(128,128,128,0.1);">
            ...
            <td style="padding: 0.5rem 0.75rem;">Group error message with <code style="${x.monoSm}">role="alert"</code> for immediate announcement</td>
          </tr>
          <tr>
            ...
            <td style="padding: 0.5rem 0.75rem;">Each radio uses <code style="${x.monoSm}">role="radio"</code> + <code style="${x.monoSm}">aria-checked</code></td>
          </tr>
        </tbody>
      </table>
      ...
      <ul style="${x.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        ...
        <li style="margin-bottom: 0.5rem;"><strong>Required:</strong> Announces "required" when <code style="${x.monoSm}">required</code> prop is set on group</li>
        <li style="margin-bottom: 0.5rem;"><strong>Error:</strong> Immediately announces group error message via <code style="${x.monoSm}">role="alert"</code></li>
        <li><strong>Helper text:</strong> Read as part of group description via <code style="${x.monoSm}">aria-describedby</code></li>
      </ul>
