import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,n as r,p as i,s as a,t as o}from"./lit-aQ4dERgF.js";import{a as s,d as c,l,n as u,t as d}from"./decorate-ClfqJe3w.js";import{n as f,r as p,t as m}from"./theme-constraints-DyQSN_xs.js";import{t as h}from"./mms-checkbox.component-B-NGa3wB.js";var g,_=e((()=>{o(),s(),h(),u(),g=class extends r{constructor(...e){super(...e),this.label=``,this.helperText=``,this.name=``,this.showTooltip=!1,this.tooltipText=``,this.colorScheme=`primary`,this.size=`md`,this.disabled=!1,this.readonly=!1,this.error=!1,this.errorText=``,this.required=!1}static{this.styles=i`
    /* ═══════════════════════════════════════════════════════════════════════
       HOST
       ═══════════════════════════════════════════════════════════════════════ */
    :host {
  ...
  `}_propagateToCheckboxes(){let e=this.shadowRoot?.querySelector(`slot`);e&&e.assignedElements({flatten:!0}).filter(e=>e.tagName===`MMS-CHECKBOX`).forEach(e=>{e.setAttribute(`color-scheme`,this.colorScheme),e.setAttribute(`size`,this.size),this.disabled?e.setAttribute(`disabled`,``):e.removeAttribute(`disabled`),this.readonly?e.setAttribute(`readonly`,``):e.removeAttribute(`readonly`),this.name&&e.setAttribute(`field-name`,this.name)})}_handleSlotChange(){this._propagateToCheckboxes()}updated(e){super.updated(e),(e.has(`colorScheme`)||e.has(`size`)||e.has(`disabled`)||e.has(`readonly`)||e.has(`name`))&&this._propagateToCheckboxes()}render(){return a`
      ...
      ${this.error&&this.errorText?a`
          ...
          `:n}
    `}},d([l({type:String})],g.prototype,`label`,void 0),d([l({type:String,attribute:`helper-text`})],g.prototype,`helperText`,void 0),d([l({type:String})],g.prototype,`name`,void 0),d([l({type:Boolean,reflect:!0,attribute:`show-tooltip`})],g.prototype,`showTooltip`,void 0),d([l({type:String,attribute:`tooltip-text`})],g.prototype,`tooltipText`,void 0),d([l({type:String,reflect:!0,attribute:`color-scheme`})],g.prototype,`colorScheme`,void 0),d([l({type:String,reflect:!0})],g.prototype,`size`,void 0),d([l({type:Boolean,reflect:!0})],g.prototype,`disabled`,void 0),d([l({type:Boolean,reflect:!0})],g.prototype,`readonly`,void 0),d([l({type:Boolean,reflect:!0})],g.prototype,`error`,void 0),d([l({type:String,attribute:`error-text`})],g.prototype,`errorText`,void 0),d([l({type:Boolean,reflect:!0})],g.prototype,`required`,void 0),g=d([c(`mms-checkbox-group`)],g)})),v=t({Overview:()=>C,PlaygroundStory:()=>w,__namedExportsOrder:()=>T,default:()=>y}),y,b,x,S,C,w,T,E=e((()=>{o(),_(),h(),f(),y={title:`Forms/Checkbox Group`,tags:[`!autodocs`]},b={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},x=`680px`,S=`960px`,C={name:`Overview`,render:()=>a`
