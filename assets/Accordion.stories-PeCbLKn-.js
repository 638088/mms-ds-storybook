import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,m as r,n as i,s as a,t as o}from"./lit-CBo78ikN.js";import{d as s,l as c,n as l,r as u,s as d,t as f}from"./decorate-Bygya6Tu.js";import{n as p,r as m}from"./focus.css-BrGuLyxh.js";import{t as h}from"./mms-icon.component-DRWi1aVe.js";import{t as g}from"./iframe-BrTwVG2K.js";import{a as _,o as v,r as y,t as b}from"./a11y-outcome-CiARakld.js";var x,S,C=e((()=>{o(),u(),m(),h(),l(),x=0,S=class extends i{constructor(){super(),this.headerText=``,this.expanded=!1,this.cuePosition=`right`,this.cueType=`caret`,this.titleSize=`body`,this.indent=!1,this.icon=``,this._handleClick=()=>{this._toggle()},this._handleKeyDown=e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this._toggle())};let e=x++;this._headerId=`mms-accordion-header-${e}`,this._bodyId=`mms-accordion-body-${e}`}static{this.styles=[p,r`
      :host {
        display: block;
