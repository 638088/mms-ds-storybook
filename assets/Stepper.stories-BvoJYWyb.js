import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,m as r,n as i,s as a,t as o,u as s}from"./lit-CBo78ikN.js";import{a as c,f as l,m as u,n as d,o as f,r as p,t as m}from"./decorate-BdwtT8fT.js";import{t as h}from"./mms-icon.component-B0xp-9Qj.js";import{n as g}from"./iframe-DuNKalfB.js";import{n as _,r as v,t as y}from"./theme-constraints-HoH5pJ5P.js";import{a as b,o as x,r as S,t as C}from"./a11y-outcome-DcpqwzN2.js";var w,T,E=e((()=>{o(),f(),c(),h(),g(),d(),w={completed:`Completed`,"needs-attention":`Needs attention`,disabled:`Disabled`},T=class extends i{constructor(...e){super(...e),this.type=`vertical`,this.colorScheme=`primary`,this.items=[],this.label=`Progress steps`,this.showStepNumbers=!0,this.radialSize=`large`,this.radialAlignment=`top`,this.actionLabel=``,this.currentStepLabel=``,this.nextStepLabel=``,this.labelSize=`heading-3`,this.labelBold=!1,this.isLastStep=!1,this.forceCompact=!1,this._handleActionClick=()=>{this.dispatchEvent(new CustomEvent(`action-click`,{bubbles:!0,composed:!0}))}}static{this.styles=[p,r`
      /* ========== HOST ========== */
      :host {
        display: block;
    ...
    `]}_handleStepClick(e,t){e.state!==`disabled`&&this.dispatchEvent(new CustomEvent(`step-click`,{bubbles:!0,composed:!0,detail:{index:t,label:e.label,state:e.state??`not-started`}}))}_handleSubstepClick(e,t,n){e.state!==`disabled`&&this.dispatchEvent(new CustomEvent(`substep-click`,{bubbles:!0,composed:!0,detail:{stepIndex:t,substepIndex:n,label:e.label,state:e.state??`not-started`}}))}_handleActivateKey(e,t){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())}_renderStepIcon(e,t){switch(e){case`current`:return a`
        ...
        `}}_stateAnnouncement(e){let t=w[e];return t?a`<span class="visually-hidden">${t}</span>`:n}_renderVertical(){return a`
    ...
    `}render(){switch(this.type){case`radial`:return this._renderRadial();case`horizontal-line`:return this._renderHorizontalLine();default:return a`
          <div class="responsive-full">${this._renderVertical()}</div>
          <div class="responsive-compact">${this._renderResponsiveRadial()}</div>
        `}}},m([l({type:String,reflect:!0})],T.prototype,`type`,void 0),m([l({type:String,reflect:!0,attribute:`color-scheme`})],T.prototype,`colorScheme`,void 0),m([l({type:Array})],T.prototype,`items`,void 0),m([l({type:String})],T.prototype,`label`,void 0),m([l({type:Boolean,attribute:`show-step-numbers`})],T.prototype,`showStepNumbers`,void 0),m([l({type:String,attribute:`radial-size`})],T.prototype,`radialSize`,void 0),m([l({type:String,attribute:`radial-alignment`})],T.prototype,`radialAlignment`,void 0),m([l({type:String,attribute:`action-label`})],T.prototype,`actionLabel`,void 0),m([l({type:String,attribute:`current-step-label`})],T.prototype,`currentStepLabel`,void 0),m([l({type:String,attribute:`next-step-label`})],T.prototype,`nextStepLabel`,void 0),m([l({type:String,attribute:`label-size`})],T.prototype,`labelSize`,void 0),m([l({type:Boolean,attribute:`label-bold`})],T.prototype,`labelBold`,void 0),m([l({type:Boolean,attribute:`is-last-step`})],T.prototype,`isLastStep`,void 0),m([l({type:Boolean,reflect:!0,attribute:`force-compact`})],T.prototype,`forceCompact`,void 0),T=m([u(`mms-stepper`)],T)})),D=t({LayoutBehavior:()=>z,Overview:()=>R,PlaygroundStory:()=>U,ResponsiveDemo:()=>B,ResponsiveDemoHorizontal:()=>H,ResponsiveDemoRail:()=>V,__namedExportsOrder:()=>W,default:()=>O}),O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G=e((()=>{o(),E(),b(),C(),_(),O={title:`Navigational/Stepper`,tags:[`!autodocs`]},k={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},A=`680px`,j=`960px`,M={frame:`border: 2px dashed rgba(128,128,128,0.35); border-radius: 8px; padding: 2rem 1.5rem 1rem; position: relative; margin-bottom: 0.75rem;`,frameLabel:`position: absolute; top: -0.7rem; left: 1rem; background: var(--color-surface-default, #fff); padding: 0 0.5rem; font-size: 0.75rem; font-weight: 600; opacity: 0.6; text-transform: uppercase; letter-spacing: 0.05em;`,caption:`font-size: 0.8125rem; opacity: 0.65; text-align: center; margin: 0.5rem 0 0;`,callout:e=>`background: ${e}0d; border-left: 3px solid ${e}; padding: 1rem 1.25rem; margin-bottom: 1.5rem; border-radius: 0 6px 6px 0;`,viewportBox:`border: 1px solid rgba(128,128,128,0.3); border-radius: 6px; padding: 1.25rem 1rem; background: rgba(128,128,128,0.03); display: flex; align-items: center; justify-content: center;`,widthRow:`margin: 0.75rem 12% 0; height: 1.125rem; border-top: 1px solid rgba(128,128,128,0.3); border-left: 1px solid rgba(128,128,128,0.3); border-right: 1px solid rgba(128,128,128,0.3); border-radius: 4px 4px 0 0; display: flex; align-items: flex-end; justify-content: center;`,widthLabel:`font-size: 0.75rem; opacity: 0.55; font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; transform: translateY(0.6rem); background: var(--color-surface-default, #fff); padding: 0 0.375rem; white-space: nowrap;`},N=[{label:`Account details`,state:`completed`},{label:`Eligibility information`,state:`completed`},{label:`Household information`,state:`current`,substeps:[{label:`Household members`,state:`completed`},{label:`Income verification`,state:`current`},{label:`Additional documentation`,state:`not-started`}]},{label:`Confirmation`,state:`not-started`}],P=[{label:`Account details`,state:`completed`},{label:`Eligibility information`,state:`completed`},{label:`Household information`,state:`current`},{label:`Confirmation`,state:`not-started`}],F=[{label:`Personal info`,state:`completed`},{label:`Program selection`,state:`completed`},{label:`Documents`,state:`current`},{label:`Review`,state:`not-started`}],I=[{label:`Personal info`,state:`completed`},{label:`Program selection`,state:`completed`},{label:`Documents`,state:`current`},{label:`Review`,state:`not-started`},{label:`Confirmation`,state:`not-started`}],L=[{label:`Not started`,state:`not-started`},{label:`Current`,state:`current`},{label:`Completed`,state:`completed`},{label:`Needs attention`,state:`needs-attention`},{label:`Disabled`,state:`disabled`}],R={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${j}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <!-- Header -->
      <h1 style="${k.h1}">Stepper</h1>
      <p style="${k.body} opacity: 0.85; max-width: ${A}; margin-bottom: 2rem;">
        Displays the steps and progress through a task or journey, driven by a single <code style="${k.monoSm}">items</code>
        array. <code style="${k.monoSm}">vertical</code> and <code style="${k.monoSm}">horizontal-line</code> are the
        two layouts you choose between directly. <code style="${k.monoSm}">radial</code> is <code style="${k.monoSm}">vertical</code>'s
        responsive pair, not a third independent choice — it's the compact view vertical automatically becomes
        below the responsive breakpoint. It's still a real, settable <code style="${k.monoSm}">type</code>, shown
      ...
      <!-- Vertical -->
      <h2 style="${k.h2}">Vertical</h2>
      <p style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin-bottom: 1.5rem;">
        The default layout. Best for long or detailed journeys — supports optional <code style="${k.monoSm}">substeps</code>
      ...
      <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px; margin-bottom: 2rem; max-width: 420px;">
        <mms-stepper type="vertical" label="Application progress" .items=${N}></mms-stepper>
      </div>

      <hr style="border: none; border-top: 1px solid rgba(128,128,128,0.15); margin: 0 0 2rem;" />

      <!-- Radial -->
      <h2 style="${k.h2}">Radial</h2>
      <p style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin-bottom: 1.5rem;">
        ...
        The two demos below share the same size and alignment (large, top-aligned) and differ only in the axis
        that actually matters here: whether there's a next step (with an action button) or it's the last step.
      </p>

      <div style="display: flex; gap: 2rem; flex-wrap: wrap; margin-bottom: 1rem;">
        <div style="flex: 1; min-width: 280px; padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px;">
          <p style="${k.caption} opacity: 0.65; margin-bottom: 0.75rem;"><strong>Large, top-aligned, with action</strong></p>
          <mms-stepper
            type="radial"
            label="Task progress"
            .items=${F}
        ...
        <div style="flex: 1; min-width: 280px; padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px;">
          <p style="${k.caption} opacity: 0.65; margin-bottom: 0.75rem;"><strong>Large, top-aligned, last step</strong></p>
          <mms-stepper
            type="radial"
            label="Task progress"
      ...
      <h3 style="${k.h3} opacity: 1; margin-top: 2.5rem;">Responsive collapse</h3>
      <p style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin-bottom: 1.5rem;">
        Below a 768px viewport, <code style="${k.monoSm}">vertical</code> automatically collapses into the compact
        radial view above. <code style="${k.monoSm}">horizontal-line</code> never collapses — instead its row
        scrolls horizontally so full labels stay legible instead of being truncated or shrunk. Resize the window
        to see vertical's collapse live, or use the <code style="${k.monoSm}">force-compact</code> attribute to
      ...
      <!-- Horizontal line -->
      <h2 style="${k.h2}">Horizontal line</h2>
      <p style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin-bottom: 1.5rem;">
      ...
      <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px; margin-bottom: 2rem;">
        <mms-stepper type="horizontal-line" label="Enrollment progress" .items=${F}></mms-stepper>
      </div>

      <hr style="border: none; border-top: 1px solid rgba(128,128,128,0.15); margin: 0 0 2rem;" />

      <!-- Step states -->
      <h2 style="${k.h2}">Step states</h2>
      <p style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin-bottom: 1.5rem;">
        Five states are available per step (and per substep): <code style="${k.monoSm}">not-started</code>,
        <code style="${k.monoSm}">current</code>, <code style="${k.monoSm}">completed</code>,
        <code style="${k.monoSm}">needs-attention</code>, and <code style="${k.monoSm}">disabled</code>.
      ...
      <div style="padding: 1.25rem; background: rgba(128,128,128,0.05); border-radius: 8px; margin-bottom: 2rem; max-width: 420px;">
        <mms-stepper type="vertical" label="Step states" .items=${L}></mms-stepper>
      </div>
      ...
      <pre style="background: rgba(128,128,128,0.08); padding: 1rem; border-radius: 6px; overflow-x: auto; ${k.monoSm}"><code>const items = [
...
&lt;mms-stepper type="vertical" label="Application progress" .items=\${items}&gt;&lt;/mms-stepper&gt;</code></pre>
      ...
      <ul style="${k.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        <li style="margin-bottom: 0.5rem;"><strong>Structure:</strong> Steps render as a <code style="${k.monoSm}">role="list"</code>/<code style="${k.monoSm}">role="listitem"</code> group with an <code style="${k.monoSm}">aria-label</code> naming the overall list.</li>
        <li style="margin-bottom: 0.5rem;"><strong>Current step:</strong> Announced via <code style="${k.monoSm}">aria-current="step"</code> — never conveyed by color alone.</li>
        ...
        <li style="margin-bottom: 0.5rem;"><strong>Radial tracker:</strong> The circular progress SVG carries <code style="${k.monoSm}">role="img"</code> with an <code style="${k.monoSm}">aria-label</code> of "Step X of Y"; the current/next label group is <code style="${k.monoSm}">aria-live="polite"</code> so step changes are announced.</li>
        <li><strong>Decorative icons:</strong> All state icons are <code style="${k.monoSm}">aria-hidden</code> — the accessible name comes from the label text and state announcement, not the icon.</li>
      </ul>
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 2rem; font-size: 0.875rem;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="padding: 0.5rem 0.75rem;">Activate the focused step, substep, or action button, firing <code style="${k.monoSm}">step-click</code>, <code style="${k.monoSm}">substep-click</code>, or <code style="${k.monoSm}">action-click</code>.</td>
          </tr>
        </tbody>
      </table>

    </div>
  `},z={name:`Layout & Behavior`,render:(e,t)=>{let n=`globals=backgrounds.value:${t.globals?.backgrounds?.value===`dark`?`dark`:`light`}`;return a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${j}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">

      <!-- Intro -->
      <h1 style="${k.h1}">Layout &amp; Behavior</h1>
      <p style="${k.body} opacity: 0.85; max-width: ${A}; margin-bottom: 1rem;">
      ...
      <ul style="${k.body} opacity: 0.85; max-width: ${A}; margin: 0 0 1.5rem; padding-left: 1.25rem;">
        <li style="margin-bottom: 0.5rem;">
          <code style="${k.monoSm}">horizontal-line</code> sits above the main content, spanning its full width, to
          aid navigation across the page.
        </li>
        <li style="margin-bottom: 0.5rem;">
          <code style="${k.monoSm}">vertical</code> sits in a left-hand column beside the main content, with the
          right-hand panel reflecting the current step (see the breakpoint diagram below).
        </li>
        <li>
          <code style="${k.monoSm}">radial</code>, when used as a standalone widget rather than vertical's
      ...
      <!-- Choosing a layout -->
      <h2 style="${k.h2}">Choosing a layout</h2>
      <p style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin-bottom: 1rem;">
        Three layouts share one <code style="${k.monoSm}">items</code> array — switching
        <code style="${k.monoSm}">type</code> doesn't require reshaping data:
      </p>
      <ul style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin: 0 0 1rem; padding-left: 1.25rem;">
        <li style="margin-bottom: 0.5rem;">
          <strong>Vertical</strong> — the default. Use for long or detailed journeys, or when any step needs
          <code style="${k.monoSm}">substeps</code> (the only layout that supports them). No practical item-count
        ...
        <li style="margin-bottom: 0.5rem;">
          ...
          <code style="${k.monoSm}">vertical</code> automatically becomes below the responsive breakpoint (see
          "Responsive collapse" below), documented and selectable here — and in the Playground via
          <code style="${k.monoSm}">type="radial"</code> — so it can be previewed directly. Set it directly only
      ...
      <!-- Responsive collapse -->
      <h2 style="${k.h2}">Responsive collapse</h2>
      <p style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin-bottom: 0.75rem;">
        Below <strong>768px</strong>, <code style="${k.monoSm}">vertical</code> collapses into the compact radial
        view automatically — a single <code style="${k.monoSm}">@media</code> rule, no JS measurement.
        <code style="${k.monoSm}">horizontal-line</code> has no part in this — it never collapses (see Overflow
        below).
      </p>
      <ul style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin: 0 0 1.5rem; padding-left: 1.25rem;">
        <li style="margin-bottom: 0.5rem;">
        ...
        <li style="margin-bottom: 0.5rem;">
          Radial isn't a separate, disconnected mode — it reads the same <code style="${k.monoSm}">items</code>
          array for its "Step X of Y" counter, whether it got there by auto-collapsing or via
          <code style="${k.monoSm}">type="radial"</code> directly.
        </li>
        <li>
          The one exception is label <em>text</em>: auto-collapse derives it from the current/next item's own
          <code style="${k.monoSm}">label</code>. A standalone radial widget sets it manually instead, via
          <code style="${k.monoSm}">current-step-label</code>/<code style="${k.monoSm}">next-step-label</code>
          (plus <code style="${k.monoSm}">is-last-step</code>).
        </li>
      </ul>
      ...
      <div style="display: flex; flex-direction: column; gap: 1.5rem; margin-bottom: 0.5rem;">
        <div style="width: 100%;">
          <div style="${M.frame}">
            <span style="${M.frameLabel}">&gt; 768px viewport</span>
            <div style="${M.viewportBox}">
              <iframe
            ...
            <div style="${M.widthRow}"><span style="${M.widthLabel}">vertical, as a rail beside content</span></div>
          </div>
          <p style="${M.caption}">Above the breakpoint — vertical renders in full, as a narrow rail next to the page's main content</p>
        </div>
        <div style="max-width: 420px;">
          <div style="${M.frame}">
            <span style="${M.frameLabel}">&le; 768px viewport</span>
            <div style="${M.viewportBox} flex-direction: column; align-items: stretch; gap: 1rem;">
              <iframe
              ...
              <div style="min-height: 100px; background: rgba(128,128,128,0.06); border-radius: 6px; display: flex; align-items: center; justify-content: center;">
                <span style="${k.caption} opacity: 0.4;">Main content area</span>
              </div>
            </div>
            <div style="${M.widthRow}"><span style="${M.widthLabel}">compact radial (auto), content stacks below</span></div>
          </div>
          <p style="${M.caption}">At/below the breakpoint — same <code style="${k.monoSm}">items</code>, collapsed to radial; content stacks below rather than sitting beside it</p>
        </div>
      </div>
      <p style="${k.caption} opacity: 0.55; max-width: ${A}; margin-bottom: 1rem;">
        Each frame embeds the real component in its own <code style="${k.monoSm}">iframe</code>, pinned to a
        literal pixel width so its <code style="${k.monoSm}">@media</code> query actually evaluates for that
      ...
      <!-- Interactivity model -->
      <h2 style="${k.h2}">Interactivity model</h2>
      <p style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin-bottom: 1rem;">
      ...
      <ul style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin: 0 0 1rem; padding-left: 1.25rem;">
        <li style="margin-bottom: 0.5rem;">
          ...
          <code style="${k.monoSm}">tabindex="0"</code>, <code style="${k.monoSm}">role="button"</code>, and a
          click/Enter/Space handler firing <code style="${k.monoSm}">step-click</code> or
          <code style="${k.monoSm}">substep-click</code>. Disabled steps drop to
          <code style="${k.monoSm}">tabindex="-1"</code> and don't fire.
        </li>
        <li style="margin-bottom: 0.5rem;">
          <strong>Radial</strong> — no per-step controls (no per-step DOM to click); the only control is the
          single optional action button, firing <code style="${k.monoSm}">action-click</code>.
        </li>
        <li>
          <strong>Horizontal-line</strong> — same model as vertical, at the step level: each
          <code style="${k.monoSm}">.hr-label</code> is <code style="${k.monoSm}">tabindex="0"</code>,
          <code style="${k.monoSm}">role="button"</code>, click/Enter/Space-activated, firing
          <code style="${k.monoSm}">step-click</code>. Disabled steps drop to
          <code style="${k.monoSm}">tabindex="-1"</code>. No substeps in this layout, so no
          <code style="${k.monoSm}">substep-click</code> equivalent.
        </li>
      </ul>
      <div style="${M.callout(`#3B82F6`)}">
        <p style="${k.bodySm} margin: 0;">
      ...
      <!-- Overflow -->
      <h2 style="${k.h2}">Overflow (horizontal-line)</h2>
      <p style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin-bottom: 0.5rem;">
        Horizontal-line has no breakpoint — it scrolls instead of collapsing:
      </p>
      <ul style="${k.bodySm} opacity: 0.85; max-width: ${A}; margin: 0 0 1rem; padding-left: 1.25rem;">
        <li style="margin-bottom: 0.5rem;">
          <code style="${k.monoSm}">.hr-line-container</code> is <code style="${k.monoSm}">overflow-x: auto</code>;
          each item is <code style="${k.monoSm}">flex: 1; min-width: 100px</code> — items shrink toward that floor,
          then the row scrolls once they can't shrink further.
        </li>
        <li style="margin-bottom: 0.5rem;">
          Each <code style="${k.monoSm}">.hr-label</code> is already keyboard-focusable, so the scrollable region
          satisfies axe's <code style="${k.monoSm}">scrollable-region-focusable</code> rule with no extra
          <code style="${k.monoSm}">tabindex</code> needed.
        </li>
        <li>
          The scrollbar below sits on an outer wrapper the docs page owns, not on
          <code style="${k.monoSm}">.hr-line-container</code> itself — that internal scrollbar is
      ...
      <div style="width: 100%; margin-bottom: 0.5rem;">
        <div style="${M.frame}">
          <span style="${M.frameLabel}">375px viewport</span>
          <div style="${M.viewportBox}">
            <iframe
          ...
          <div style="${M.widthRow}"><span style="${M.widthLabel}">full row, scrollable</span></div>
        </div>
        <p style="${M.caption}">Five items at their natural width need more than 375px, so the row scrolls instead of collapsing.</p>
      </div>

      <hr style="border: none; border-top: 1px solid rgba(128,128,128,0.15); margin: 2rem 0;" />

      <!-- Other considerations -->
      <h2 style="${k.h2}">Other considerations</h2>
      <ul style="${k.bodySm} margin: 0; padding-left: 1.5rem; opacity: 0.85; max-width: ${A};">
        <li style="margin-bottom: 0.75rem;">
          <span style="${M.callout(`#22C55E`).replace(`padding: 1rem 1.25rem;`,`padding: 0.0625rem 0.5rem;`).replace(`margin-bottom: 1.5rem;`,``).replace(`border-radius: 0 6px 6px 0;`,`border-radius: 3px;`).replace(`border-left: 3px solid #22C55E;`,`border: none;`)}; font-size: 0.6875rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.03em;">Current behavior</span>
        ...
        <li style="margin-bottom: 0.75rem;">
          <span style="${M.callout(`#3B82F6`).replace(`padding: 1rem 1.25rem;`,`padding: 0.0625rem 0.5rem;`).replace(`margin-bottom: 1.5rem;`,``).replace(`border-radius: 0 6px 6px 0;`,`border-radius: 3px;`).replace(`border-left: 3px solid #3B82F6;`,`border: none;`)}; font-size: 0.6875rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.03em;">Consumer-owned</span>
          Navigating via <code style="${k.monoSm}">step-click</code>/<code style="${k.monoSm}">substep-click</code>
          doesn't change <code style="${k.monoSm}">items</code> itself — the component never mutates its own state
          on click. The host page owns re-rendering with updated step states in response to the event.
        </li>
        <li>
          <span style="${M.callout(`#22C55E`).replace(`padding: 1rem 1.25rem;`,`padding: 0.0625rem 0.5rem;`).replace(`margin-bottom: 1.5rem;`,``).replace(`border-radius: 0 6px 6px 0;`,`border-radius: 3px;`).replace(`border-left: 3px solid #22C55E;`,`border: none;`)}; font-size: 0.6875rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.03em;">Current behavior</span>
          <code style="${k.monoSm}">force-compact</code> is a demo/test escape hatch (documented as such in the
    ...
    `}},B={name:`Responsive demo (internal)`,tags:[`!dev`],render:()=>a`
    <mms-stepper type="vertical" label="Enrollment progress" .items=${P}></mms-stepper>
  `},V={name:`Responsive demo rail (internal)`,tags:[`!dev`],render:()=>a`
  ...
  `},H={name:`Responsive demo horizontal (internal)`,tags:[`!dev`],render:()=>a`
...
}`,...U.parameters?.docs?.source}}},W=[`Overview`,`LayoutBehavior`,`ResponsiveDemo`,`ResponsiveDemoRail`,`ResponsiveDemoHorizontal`,`PlaygroundStory`]}));G();export{z as LayoutBehavior,R as Overview,U as PlaygroundStory,B as ResponsiveDemo,H as ResponsiveDemoHorizontal,V as ResponsiveDemoRail,W as __namedExportsOrder,O as default,G as n,D as t};