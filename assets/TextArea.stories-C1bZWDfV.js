import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,m as r,n as i,s as a,t as o}from"./lit-CBo78ikN.js";import{d as s,l as c,n as l,r as u,t as d}from"./decorate-Bygya6Tu.js";import{r as f,t as p}from"./focus.css-BrGuLyxh.js";import{t as m}from"./mms-icon.component-BJPQucU2.js";import{a as h,o as g,r as _,t as v}from"./a11y-outcome-DdXFaPju.js";import{t as y}from"./mms-tooltip.component-D_aMEIgp.js";var b,x=e((()=>{o(),u(),f(),m(),y(),l(),b=class extends i{constructor(...e){super(...e),this.size=`md`,this.state=`default`,this.disabled=!1,this.readonly=!1,this.resize=`vertical`,this._rows=3,this.label=``,this.placeholder=``,this.helperText=``,this.name=``,this.value=``,this.autocomplete=``,this.required=!1,this.error=!1,this.errorText=``,this.maxLength=0,this.showCharacterCounter=!1,this.showTooltip=!1,this.tooltipText=``}get rows(){return this._rows}set rows(e){let t=this._rows;this._rows=Math.min(15,Math.max(2,e)),this.requestUpdate(`rows`,t)}get ariaDescribedBy(){let e=[];return this.helperText&&!this.error&&e.push(`helper-text`),this.error&&this.errorText&&e.push(`error-text`),this.showCharacterCounter&&this.maxLength>0&&e.push(`char-counter`),e.join(` `)||void 0}get charsRemaining(){return this.maxLength-this.value.length}static{this.styles=[p,r`
    ...
    `]}_handleInput(e){if(e.stopPropagation(),this.disabled||this.readonly)return;let t=e.target,n=this.value,r=t.value;this.maxLength>0&&r.length>this.maxLength&&(r=r.slice(0,this.maxLength),t.value=r),this.value=r,this.dispatchEvent(new CustomEvent(`input`,{detail:{value:this.value,oldValue:n},bubbles:!0,composed:!0}))}_handleFocus(e){e.stopPropagation(),!this.disabled&&(this.state=`focus`,this.dispatchEvent(new CustomEvent(`focus`,{detail:{value:this.value},bubbles:!0,composed:!0})))}_handleBlur(e){e.stopPropagation(),!this.disabled&&(this.state=this.value?`filled`:`default`,this.dispatchEvent(new CustomEvent(`blur`,{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent(`change`,{detail:{value:this.value},bubbles:!0,composed:!0})))}render(){return a`
      ${this.label?a`
            <div class="label-row">
      ...
      ${this.error&&this.errorText&&!this.disabled?a`
          ...
          `:n}
    `}},d([c({type:String,reflect:!0})],b.prototype,`size`,void 0),d([c({type:String,reflect:!0})],b.prototype,`state`,void 0),d([c({type:Boolean,reflect:!0})],b.prototype,`disabled`,void 0),d([c({type:Boolean,reflect:!0})],b.prototype,`readonly`,void 0),d([c({type:String,reflect:!0})],b.prototype,`resize`,void 0),d([c({type:Number})],b.prototype,`rows`,null),d([c({type:String})],b.prototype,`label`,void 0),d([c({type:String})],b.prototype,`placeholder`,void 0),d([c({type:String,attribute:`helper-text`})],b.prototype,`helperText`,void 0),d([c({type:String})],b.prototype,`name`,void 0),d([c({type:String,reflect:!0})],b.prototype,`value`,void 0),d([c({type:String})],b.prototype,`autocomplete`,void 0),d([c({type:Boolean,reflect:!0})],b.prototype,`required`,void 0),d([c({type:Boolean,reflect:!0})],b.prototype,`error`,void 0),d([c({type:String,attribute:`error-text`})],b.prototype,`errorText`,void 0),d([c({type:Number,attribute:`max-length`})],b.prototype,`maxLength`,void 0),d([c({type:Boolean,attribute:`show-character-counter`})],b.prototype,`showCharacterCounter`,void 0),d([c({type:Boolean,reflect:!0,attribute:`show-tooltip`})],b.prototype,`showTooltip`,void 0),d([c({type:String,attribute:`tooltip-text`})],b.prototype,`tooltipText`,void 0),b=d([s(`mms-text-area`)],b)})),S=t({Overview:()=>D,PlaygroundStory:()=>O,__namedExportsOrder:()=>k,default:()=>C}),C,w,T,E,D,O,k,A=e((()=>{o(),x(),h(),v(),C={title:`Forms/Text Area`,tags:[`!autodocs`]},w={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},T=`680px`,E=`960px`,D={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${E}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <!-- Character Counter -->
      <h2 style="${w.h2}">Character counter</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        Set <code style="${w.monoSm}">max-length</code> and <code style="${w.monoSm}">show-character-counter</code>
      ...
      <!-- Rows and Resize -->
      <h2 style="${w.h2}">Rows and resize behavior</h2>
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        The <code style="${w.monoSm}">rows</code> prop sets the initial visible height.
        <code style="${w.monoSm}">resize</code> controls whether the user can drag-resize vertically
        (<code style="${w.monoSm}">vertical</code>, default) or not at all (<code style="${w.monoSm}">none</code>).
      </p>
      ...
      <p style="${w.bodySm} opacity: 0.85; max-width: ${T}; margin-bottom: 1.5rem;">
        ...
        Consistent with <code style="${w.monoSm}">mms-text-field</code> sizing.
      </p>
      ...
      <div style="width: 240px; background: rgba(128,128,128,0.1); padding: 1rem; border-radius: 8px; margin-bottom: 2rem;">
        <p style="${w.caption} margin-bottom: 0.25rem;"><strong>Narrow container (240px)</strong></p>
      ...
      <ul style="${w.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        ...
        <li style="margin-bottom: 0.5rem;"><strong>Character counter:</strong> Announces remaining characters via <code style="${w.monoSm}">aria-live="polite"</code> as the user types</li>
