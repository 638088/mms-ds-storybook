import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,m as r,n as i,s as a,t as o}from"./lit-CBo78ikN.js";import{f as s,m as c,n as l,o as u,t as d,u as f}from"./decorate-BdwtT8fT.js";import{t as p}from"./mms-icon.component-B0xp-9Qj.js";import{n as m,r as h,t as g}from"./theme-constraints-HoH5pJ5P.js";import{a as _,o as v,r as y,t as b}from"./a11y-outcome-DcpqwzN2.js";import{t as x}from"./mms-tooltip.component-DX3p7ZJI.js";import{t as S}from"./mms-radio.component-C_UnkM4f.js";var C,w=e((()=>{o(),u(),S(),p(),x(),l(),C=class extends i{constructor(...e){super(...e),this.label=``,this.helperText=``,this.name=``,this.value=``,this.showTooltip=!1,this.tooltipText=``,this.colorScheme=`primary`,this.size=`md`,this.orientation=`vertical`,this.disabled=!1,this.readonly=!1,this.error=!1,this.errorText=``,this.required=!1,this._radios=[],this._handleRadioChange=e=>{let t=e.target;if(t.tagName!==`MMS-RADIO`)return;let n=t.getAttribute(`value`)||``;n!==this.value&&(this.value=n,this._propagateToRadios(),this.dispatchEvent(new CustomEvent(`change`,{detail:{value:this.value},bubbles:!0,composed:!0})))},this._handleKeyDown=e=>{if(this.disabled||this.readonly)return;let t=this._radios.filter(e=>!e.hasAttribute(`disabled`));if(t.length===0)return;let n=this._getSelectedIndex(),r=n;switch(e.key){case`ArrowDown`:case`ArrowRight`:e.preventDefault(),r=n<0?0:(n+1)%t.length;break;case`ArrowUp`:case`ArrowLeft`:e.preventDefault(),r=n<0?t.length-1:(n-1+t.length)%t.length;break;case` `:case`Enter`:n<0&&(e.preventDefault(),r=0);break;default:return}if(r!==n&&t[r]){let e=t[r].getAttribute(`value`)||``;this.value=e,this._propagateToRadios(),t[r].focus(),this.dispatchEvent(new CustomEvent(`change`,{detail:{value:this.value},bubbles:!0,composed:!0}))}}}static{this.styles=r`
  ...
  `}connectedCallback(){super.connectedCallback(),this.addEventListener(`keydown`,this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`keydown`,this._handleKeyDown)}updated(e){super.updated(e),(e.has(`colorScheme`)||e.has(`size`)||e.has(`disabled`)||e.has(`readonly`)||e.has(`name`)||e.has(`value`))&&this._propagateToRadios()}_getRadios(){let e=this.shadowRoot?.querySelector(`slot`);return e?e.assignedElements({flatten:!0}).filter(e=>e.tagName===`MMS-RADIO`):[]}_propagateToRadios(){let e=this._getRadios();this._radios=e,e.forEach((e,t)=>{e.setAttribute(`color-scheme`,this.colorScheme),e.setAttribute(`size`,this.size),this.disabled?e.setAttribute(`disabled`,``):e.removeAttribute(`disabled`),this.readonly?e.setAttribute(`readonly`,``):e.removeAttribute(`readonly`),this.name&&e.setAttribute(`field-name`,this.name);let n=e.getAttribute(`value`)||``;this.value&&n===this.value?e.setAttribute(`selected`,``):e.removeAttribute(`selected`);let r=this._getSelectedIndex();t===(r>=0?r:0)&&!this.disabled?e.removeAttribute(`tabindex`):e.setAttribute(`tabindex`,`-1`)})}_getSelectedIndex(){return this._radios.findIndex(e=>e.getAttribute(`value`)===this.value)}_handleSlotChange(){this._propagateToRadios()}render(){return a`
      ...
      ${this.error&&this.errorText?a`
          ...
          `:n}
    `}},d([s({type:String})],C.prototype,`label`,void 0),d([s({type:String,attribute:`helper-text`})],C.prototype,`helperText`,void 0),d([s({type:String})],C.prototype,`name`,void 0),d([s({type:String,reflect:!0})],C.prototype,`value`,void 0),d([s({type:Boolean,reflect:!0,attribute:`show-tooltip`})],C.prototype,`showTooltip`,void 0),d([s({type:String,attribute:`tooltip-text`})],C.prototype,`tooltipText`,void 0),d([s({type:String,reflect:!0,attribute:`color-scheme`})],C.prototype,`colorScheme`,void 0),d([s({type:String,reflect:!0})],C.prototype,`size`,void 0),d([s({type:String,reflect:!0})],C.prototype,`orientation`,void 0),d([s({type:Boolean,reflect:!0})],C.prototype,`disabled`,void 0),d([s({type:Boolean,reflect:!0})],C.prototype,`readonly`,void 0),d([s({type:Boolean,reflect:!0})],C.prototype,`error`,void 0),d([s({type:String,attribute:`error-text`})],C.prototype,`errorText`,void 0),d([s({type:Boolean,reflect:!0})],C.prototype,`required`,void 0),d([f()],C.prototype,`_radios`,void 0),C=d([c(`mms-radio-group`)],C)})),T=t({Overview:()=>A,PlaygroundStory:()=>j,__namedExportsOrder:()=>M,default:()=>E}),E,D,O,k,A,j,M,N=e((()=>{o(),w(),S(),m(),_(),b(),E={title:`Forms/Radio Group`,tags:[`!autodocs`]},D={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},O=`680px`,k=`960px`,A={name:`Overview`,render:()=>a`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${k}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
        Wrap multiple <code style="${D.monoSm}">&lt;mms-radio&gt;</code> elements inside a group 
      ...
      <!-- With Helper Text -->
      <h2 style="${D.h2}">With helper text</h2>
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
      ...
      <h2 style="${D.h2}">Horizontal orientation</h2>
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
        Use <code style="${D.monoSm}">orientation="horizontal"</code> for inline layouts.
      </p>
      ...
      <!-- Required Group -->
      <h2 style="${D.h2}">Required group</h2>
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
        The <code style="${D.monoSm}">required</code> prop adds an asterisk indicator to the label.
      </p>
      ...
      <!-- Error State -->
      <h2 style="${D.h2}">Error state</h2>
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
        The <code style="${D.monoSm}">error</code> prop displays validation feedback for the entire group.
      ...
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
        The <code style="${D.monoSm}">color-scheme</code> prop propagates to all child radios.
      </p>
      ...
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
        The <code style="${D.monoSm}">size</code> prop propagates to all child radios.
      </p>
      ...
      <!-- Disabled & Readonly -->
      <h2 style="${D.h2}">Disabled &amp; read-only</h2>
      <p style="${D.bodySm} opacity: 0.85; max-width: ${O}; margin-bottom: 1.5rem;">
      ...
      <ul style="${D.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        ...
        <li style="margin-bottom: 0.5rem;"><strong>Required:</strong> Announces "required" when <code style="${D.monoSm}">required</code> prop is set on group</li>
        <li style="margin-bottom: 0.5rem;"><strong>Error:</strong> Immediately announces group error message via <code style="${D.monoSm}">role="alert"</code></li>
        <li><strong>Helper text:</strong> Read as part of group description via <code style="${D.monoSm}">aria-describedby</code></li>
      </ul>
  ...
  `)}\n>\n${i.join(`
`)}\n</mms-radio-group>`},language:`html`}}},render:e=>{let t=h(e.theme,e.colorScheme),r=g(e.theme,e.colorScheme);if(!t){let t=r===2?`Tier 2 (Text + Surface)`:`Tier 3 (Decorative)`,n=r===2?`Lacks step 10 (hover state). Use for branded text or badges, not radios.`:`Lacks text contrast and hover states. Decorative backgrounds only.`;return a`
        <div style="
          padding: 1.5rem 2rem;
          background: #fef2f2;
...
}`,...j.parameters?.docs?.source}}},M=[`Overview`,`PlaygroundStory`]}));N();export{A as Overview,j as PlaygroundStory,M as __namedExportsOrder,E as default,N as n,T as t};