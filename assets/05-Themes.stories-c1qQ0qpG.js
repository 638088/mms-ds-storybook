import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{s as t,t as n}from"./lit-CBo78ikN.js";import{r,t as i}from"./theme-constraints-xITgb_Dw.js";var a,o,s,c,l,u,d,f,p,m,h,g,_,v;e((()=>{n(),r(),a=`960px`,o=`background: #1e1e1e; color: #d4d4d4; padding: 1rem; border-radius: 8px; overflow-x: auto; font-size: 0.8125rem; margin: 0 0 1.5rem; border: 1px solid rgba(128,128,128,0.2);`,s=`font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, monospace;`,c=`background: rgba(128,128,128,0.15); padding: 2px 6px; border-radius: 4px; font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, monospace; font-size: 0.9em;`,l=`padding: 0.75rem; border: 1px solid rgba(128,128,128,0.2); vertical-align: top;`,u=`text-align: left; ${l}`,d={default:`Default`,maximus:`Maximus`,"va-gov":`VA.gov`,"uss-oh-dvs":`Ohio DVS`},f={default:`Internal only — neutral greyscale used while developing a component before any brand exists.`,maximus:`Maximus corporate brand. The starting brand for prototypes and every example in these docs.`,"va-gov":`Virginia state government engagement.`,"uss-oh-dvs":`Ohio Department of Veterans Services.`},p={default:[`—`,`system-ui`],maximus:[`Avenir Next`,`Arial`],"va-gov":[`Source Sans Pro (Roboto Mono for figures)`,`system-ui`],"uss-oh-dvs":[`Source Sans 3`,`system-ui`]},m=[`default`],h=Object.keys(i).filter(e=>!m.includes(e)),g={title:`Developer Guide/Themes`},_={name:`Themes`,render:()=>t`
    ...
    >
      ...
      <p style="margin: 0 0 1rem; font-size: 0.9375rem;">
        A theme names its brand typeface, and the package ships the font files for it. Import
        <code style=${c}>@mms/design-system/fonts.css</code> once and every theme's face is
        available. Each <code style=${c}>--font-family-*</code> stack still lists a
        widely-installed substitute after the brand face, so type stays readable while the font
        loads or if the stylesheet is not imported at all.
      </p>
      ...
      <p style="margin: 0 0 2rem; font-size: 0.9375rem;">
        <strong>Licensing is yours, not the platform's.</strong> The package carries the
        reference brand implementation so a component looks right the moment you install it.
        A team delivering a branded engagement is responsible for the font entitlement covering
        that deployment. Source Sans Pro, Source Sans 3 and Roboto Mono are OFL 1.1 / Apache 2.0
        and carry no restriction; Avenir Next is a commercial face and needs a licence you hold.
      </p>
  ...
  render: () => html\`
    ...
    >
      ...
      <p style="margin: 0 0 1rem; font-size: 0.9375rem;">
        A theme names its brand typeface, and the package ships the font files for it. Import
        <code style=\${KBD}>@mms/design-system/fonts.css</code> once and every theme's face is
        available. Each <code style=\${KBD}>--font-family-*</code> stack still lists a
        widely-installed substitute after the brand face, so type stays readable while the font
        loads or if the stylesheet is not imported at all.
      </p>
