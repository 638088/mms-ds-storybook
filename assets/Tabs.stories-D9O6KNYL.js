import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,m as r,n as i,s as a,t as o}from"./lit-CBo78ikN.js";import{f as s,m as c,n as l,o as u,t as d,u as f}from"./decorate-BdwtT8fT.js";import{t as p}from"./mms-icon.component-B0xp-9Qj.js";import{a as m,o as h,r as g,t as _}from"./a11y-outcome-DcpqwzN2.js";var v,y=e((()=>{o(),u(),p(),l(),v=class extends i{constructor(...e){super(...e),this.label=`Tab`,this.hideLabel=!1,this.active=!1,this.disabled=!1,this.tabStyle=`minimal`,this.roundness=`subtle`,this.orientation=`horizontal`,this.size=`md`,this.panelId=``,this.state=`default`,this._handleClick=()=>{this.disabled||this.dispatchEvent(new CustomEvent(`tab-select`,{bubbles:!0,composed:!0,detail:{label:this.label}}))},this._handleKeyDown=e=>{this.disabled||(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this._handleClick())}}static{this.styles=r`
    :host {
      display: inline-flex;
      align-items: center;
