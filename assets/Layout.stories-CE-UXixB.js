import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{s as t,t as n}from"./lit-CBo78ikN.js";var r,i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O;e((()=>{n(),r={title:`Foundations/Layout`},i={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},a=`680px`,o=`960px`,s=[{token:`--layout-content-max-width`,value:`1280px`,purpose:`Maximum width of the centered content container. Content stops growing here regardless of viewport width.`},{token:`--layout-inline-padding-compact`,value:`16px`,purpose:`Horizontal padding inside the content container when the viewport is below the padding step.`},{token:`--layout-inline-padding-default`,value:`32px`,purpose:`Horizontal padding inside the content container at the padding step and above.`},{token:`--layout-padding-step`,value:`768px`,purpose:`Viewport width at which padding-inline transitions from compact (16px) to default (32px).`},{token:`--layout-gap-tight`,value:`8px`,purpose:`Gap between tightly grouped horizontal items — chips, icon + label pairs, inline form controls. Aliases --spacing-sm1.`},{token:`--layout-gap-default`,value:`16px`,purpose:`Default gap between siblings in a row or column — list items, form fields, nav items. Aliases --spacing-md1.`},{token:`--layout-gap-loose`,value:`24px`,purpose:`Looser gap for cards, larger composite groups, and content blocks that need more breathing room. Aliases --spacing-lg1.`},{token:`--layout-gap-comfortable`,value:`32px`,purpose:`Comfortable gap commonly used between major composite blocks and card-grid items. Aliases --spacing-lg2.`}],c=[{label:`Below the padding step`,state:`Container fills the viewport · padding-inline = 16px`,viewport:375},{label:`At the padding step (768px)`,state:`padding-inline steps up to 32px · container still fills the viewport`,viewport:768},{label:`Below the container cap`,state:`Container continues to fill the viewport · padding-inline = 32px`,viewport:1024},{label:`At the container cap (1280px)`,state:`Container reaches max-width · no leftover space yet`,viewport:1280},{label:`Above the container cap`,state:`Container is capped and centered · leftover viewport space each side`,viewport:1920}],l=1280,u=16,d=24,f=768,p=e=>{let t=e<f?u:d,n=Math.min(e,l),r=n-t*2,i=Math.max(0,(e-n)/2);return i===0?[{w:t,kind:`padding`},{w:r,kind:`content`},{w:t,kind:`padding`}]:[{w:i,kind:`empty`},{w:t,kind:`padding`},{w:r,kind:`content`},{w:t,kind:`padding`},{w:i,kind:`empty`}]},m=e=>{let t=e<f?u:d,n=Math.min(e,l),r=n-t*2,i=Math.max(0,(e-n)/2);return i===0?`viewport ${e}px · container ${n}px · padding ${t}px each side · content ${r}px`:`viewport ${e}px · container ${n}px · padding ${t}px each side · content ${r}px · leftover ${i}px each side`},h=1920,g=780,_=e=>e===`empty`?`rgba(0,0,0,0.06)`:e===`padding`?`rgba(90,120,200,0.3)`:`rgba(90,120,200,0.75)`,v=e=>{let n=g/h,r=Math.round(e.viewport*n),a=p(e.viewport);return t`
...
`,w={name:`Layout System`,render:()=>t`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${o}; margin: 0 auto; padding: 2rem; color: inherit;">
...
@media (min-width: 768px) { /* --layout-padding-step */
  .layout-container {
    padding-inline: var(--layout-inline-padding-default); /* 32px */
  }
}</code></pre>
...
`,D={name:`Designing in Figma`,render:()=>t`
  ...
  name: 'Layout System',
  render: () => html\`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: \${PAGE_MAX}; margin: 0 auto; padding: 2rem; color: inherit;">
