    ...
    docs: {
      source: {
        transform: (_src: string, ctx: {
          ...
          if (a.maxLength && Number(a.maxLength) > 0) attrs.push(\`max-length="\${a.maxLength}"\`);
