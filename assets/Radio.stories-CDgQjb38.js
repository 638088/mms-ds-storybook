import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{s as n,t as r}from"./lit-aQ4dERgF.js";import{n as i,r as a,t as o}from"./theme-constraints-DyQSN_xs.js";import{t as s}from"./mms-radio.component-DVNPPONA.js";var c=t({Overview:()=>p,PlaygroundStory:()=>m,__namedExportsOrder:()=>h,default:()=>l}),l,u,d,f,p,m,h,g=e((()=>{r(),s(),i(),l={title:`Forms/Radio`,tags:[`!autodocs`]},u={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},d=`680px`,f=`960px`,p={name:`Overview`,render:()=>n`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: ${f}; margin: 0 auto; padding: 2rem; line-height: 1.6; color: inherit;">
      ...
      <div style="
        ...
        margin-bottom: 2rem;
      ">
        <p style="${u.bodySm} margin: 0;">
          <strong>Usage:</strong> Radio buttons should be used within <code style="${u.monoSm}">&lt;mms-radio-group&gt;</code> which handles single-selection behavior and arrow key navigation. This page documents individual radio button props.
        </p>
      </div>
      ...
      <p style="${u.bodySm} opacity: 0.85; max-width: ${d}; margin-bottom: 1.5rem;">
        The <code style="${u.monoSm}">color-scheme</code> prop controls which color palette the radio uses when selected.
      </p>
      ...
      <p style="${u.bodySm} opacity: 0.85; max-width: ${d}; margin-bottom: 1.5rem;">
        When <code style="${u.monoSm}">required</code> is set, an asterisk appears on the highest-level label. If a heading is present, the asterisk shows there; otherwise it appears on the radio label.
      </p>
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; font-size: 0.875rem;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="padding: 0.5rem 0.75rem;"><code style="${u.monoSm}">role="radio"</code> + <code style="${u.monoSm}">aria-checked</code> (true/false)</td>
          </tr>
        </tbody>
      </table>
      ...
      <ul style="${u.bodySm} margin: 0 0 1.5rem; padding-left: 1.5rem; opacity: 0.85;">
        ...
        <li style="margin-bottom: 0.5rem;"><strong>Group context:</strong> When inside <code style="${u.monoSm}">mms-radio-group</code>, announces position (e.g., "1 of 3")</li>
  ...
  `},m={name:`Playground`,tags:[`!dev`],args:{label:`Option A`,selected:!1,value:`option-a`,colorScheme:`primary`,size:`md`,state:`default`,readonly:!1,disabled:!1,error:!1,errorText:`Please select an option`,required:!1,heading:``,helperText:``,fieldName:``,theme:`maximus`},decorators:[e=>n`
        <div
          style="
            min-height: 120px;
            display: flex;
