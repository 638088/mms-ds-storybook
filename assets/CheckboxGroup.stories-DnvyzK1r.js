import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{i as n,m as r,n as i,s as a,t as o}from"./lit-CBo78ikN.js";import{d as s,l as c,n as l,r as u,t as d}from"./decorate-Bygya6Tu.js";import{t as f}from"./mms-icon.component-BJPQucU2.js";import{i as p,n as m,r as h}from"./theme-constraints-xITgb_Dw.js";import{a as g,o as _,r as v,t as y}from"./a11y-outcome-DdXFaPju.js";import{t as b}from"./mms-tooltip.component-D_aMEIgp.js";import{t as x}from"./mms-checkbox.component-BdLCfiLZ.js";var S,C=e((()=>{o(),u(),x(),f(),b(),l(),S=class extends i{constructor(...e){super(...e),this.label=``,this.helperText=``,this.name=``,this.showTooltip=!1,this.tooltipText=``,this.colorScheme=`primary`,this.size=`md`,this.disabled=!1,this.readonly=!1,this.error=!1,this.errorText=``,this.required=!1}static{this.styles=r`
    /* ═══════════════════════════════════════════════════════════════════════
       HOST
       ═══════════════════════════════════════════════════════════════════════ */
    :host {
  ...
  `}_propagateToCheckboxes(){let e=this.shadowRoot?.querySelector(`slot`);e&&e.assignedElements({flatten:!0}).filter(e=>e.tagName===`MMS-CHECKBOX`).forEach(e=>{e.setAttribute(`color-scheme`,this.colorScheme),e.setAttribute(`size`,this.size),this.disabled?e.setAttribute(`disabled`,``):e.removeAttribute(`disabled`),this.readonly?e.setAttribute(`readonly`,``):e.removeAttribute(`readonly`),this.name&&e.setAttribute(`field-name`,this.name)})}_handleSlotChange(){this._propagateToCheckboxes()}updated(e){super.updated(e),(e.has(`colorScheme`)||e.has(`size`)||e.has(`disabled`)||e.has(`readonly`)||e.has(`name`))&&this._propagateToCheckboxes()}render(){return a`
      ...
      ${this.error&&this.errorText?a`
          ...
          `:n}
    `}},d([c({type:String})],S.prototype,`label`,void 0),d([c({type:String,attribute:`helper-text`})],S.prototype,`helperText`,void 0),d([c({type:String})],S.prototype,`name`,void 0),d([c({type:Boolean,reflect:!0,attribute:`show-tooltip`})],S.prototype,`showTooltip`,void 0),d([c({type:String,attribute:`tooltip-text`})],S.prototype,`tooltipText`,void 0),d([c({type:String,reflect:!0,attribute:`color-scheme`})],S.prototype,`colorScheme`,void 0),d([c({type:String,reflect:!0})],S.prototype,`size`,void 0),d([c({type:Boolean,reflect:!0})],S.prototype,`disabled`,void 0),d([c({type:Boolean,reflect:!0})],S.prototype,`readonly`,void 0),d([c({type:Boolean,reflect:!0})],S.prototype,`error`,void 0),d([c({type:String,attribute:`error-text`})],S.prototype,`errorText`,void 0),d([c({type:Boolean,reflect:!0})],S.prototype,`required`,void 0),S=d([s(`mms-checkbox-group`)],S)})),w=t({Overview:()=>k,PlaygroundStory:()=>A,__namedExportsOrder:()=>j,default:()=>T}),T,E,D,O,k,A,j,M=e((()=>{o(),C(),x(),h(),g(),y(),T={title:`Forms/Checkbox Group`,tags:[`!autodocs`]},E={h1:`font-size: 1.875rem; line-height: 1.25; font-weight: 700; letter-spacing: -0.01em; margin: 0 0 0.5rem;`,h2:`font-size: 1.25rem; line-height: 1.35; font-weight: 700; margin: 0 0 0.75rem;`,h3:`font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 0.75rem; opacity: 0.65;`,body:`font-size: 1rem; line-height: 1.6; margin: 0;`,bodySm:`font-size: 0.9375rem; line-height: 1.55; margin: 0;`,caption:`font-size: 0.875rem; line-height: 1.5; margin: 0;`,mono:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.9375rem;`,monoSm:`font-family: ui-monospace, "SF Mono", Menlo, Consolas, monospace; font-size: 0.875rem;`},D=`680px`,O=`960px`,k={name:`Overview`,render:()=>a`
